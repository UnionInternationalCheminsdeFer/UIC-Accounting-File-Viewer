 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.TotalPassengerCombinationConstraintImpl#getId <em>Id</em>}</li>
 *   <li>{@link Accounting.impl.TotalPassengerCombinationConstraintImpl#getDataDescription <em>Data Description</em>}</li>
 *   <li>{@link Accounting.impl.TotalPassengerCombinationConstraintImpl#getMaxTotalPassengerWeight <em>Max Total Passenger Weight</em>}</li>
 *   <li>{@link Accounting.impl.TotalPassengerCombinationConstraintImpl#getMinTotalPassengerWeight <em>Min Total Passenger Weight</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TotalPassengerCombinationConstraintImpl extends MinimalEObjectImpl.Container implements TotalPassengerCombinationConstraint {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.TOTAL_PASSENGER_COMBINATION_CONSTRAINT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TOTAL_PASSENGER_COMBINATION_CONSTRAINT__ID, oldId, id));
	}
	...
	public void setDataDescription(String newDataDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TOTAL_PASSENGER_COMBINATION_CONSTRAINT__DATA_DESCRIPTION, oldDataDescription, dataDescription));
	}
	...
	public void setMaxTotalPassengerWeight(float newMaxTotalPassengerWeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TOTAL_PASSENGER_COMBINATION_CONSTRAINT__MAX_TOTAL_PASSENGER_WEIGHT, oldMaxTotalPassengerWeight, maxTotalPassengerWeight));
	}
	...
	public void setMinTotalPassengerWeight(float newMinTotalPassengerWeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TOTAL_PASSENGER_COMBINATION_CONSTRAINT__MIN_TOTAL_PASSENGER_WEIGHT, oldMinTotalPassengerWeight, minTotalPassengerWeight));
	}
