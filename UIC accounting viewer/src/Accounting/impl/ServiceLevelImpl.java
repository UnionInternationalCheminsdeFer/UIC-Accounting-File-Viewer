 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.ServiceLevelImpl#getId <em>Id</em>}</li>
 *   <li>{@link Accounting.impl.ServiceLevelImpl#getText <em>Text</em>}</li>
 *   <li>{@link Accounting.impl.ServiceLevelImpl#getCombiningServiceClasses <em>Combining Service Classes</em>}</li>
 *   <li>{@link Accounting.impl.ServiceLevelImpl#getReservationParameter <em>Reservation Parameter</em>}</li>
 *   <li>{@link Accounting.impl.ServiceLevelImpl#isIncludesClassName <em>Includes Class Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ServiceLevelImpl extends MinimalEObjectImpl.Container implements ServiceLevel {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.SERVICE_LEVEL;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.SERVICE_LEVEL__ID, oldId, id));
	}
	...
	public Text getText() {
		if (text != null && text.eIsProxy()) {
			...
			if (text != oldText) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.SERVICE_LEVEL__TEXT, oldText, text));
			}
		}
		return text;
	}
	...
	public void setText(Text newText) {
		...
		text = newText;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.SERVICE_LEVEL__TEXT, oldText, text));
	}
	...
	public ReservationParameter getReservationParameter() {
		if (reservationParameter != null && reservationParameter.eIsProxy()) {
			...
			if (reservationParameter != oldReservationParameter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.SERVICE_LEVEL__RESERVATION_PARAMETER, oldReservationParameter, reservationParameter));
			}
		}
	...
	public void setReservationParameter(ReservationParameter newReservationParameter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.SERVICE_LEVEL__RESERVATION_PARAMETER, oldReservationParameter, reservationParameter));
	}
	...
	public void setIncludesClassName(boolean newIncludesClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.SERVICE_LEVEL__INCLUDES_CLASS_NAME, oldIncludesClassName, includesClassName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.SERVICE_LEVEL__ID:
				return getId();
			case AccountingPackage.SERVICE_LEVEL__TEXT:
				if (resolve) return getText();
				return basicGetText();
			case AccountingPackage.SERVICE_LEVEL__COMBINING_SERVICE_CLASSES:
				return getCombiningServiceClasses();
			case AccountingPackage.SERVICE_LEVEL__RESERVATION_PARAMETER:
				if (resolve) return getReservationParameter();
				return basicGetReservationParameter();
			case AccountingPackage.SERVICE_LEVEL__INCLUDES_CLASS_NAME:
