...
import Accounting.RequiredReductionCard;
 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.RequiredReductionCardImpl#getCardClass <em>Card Class</em>}</li>
 *   <li>{@link Accounting.impl.RequiredReductionCardImpl#getCard <em>Card</em>}</li>
 *   <li>{@link Accounting.impl.RequiredReductionCardImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequiredReductionCardImpl extends MinimalEObjectImpl.Container implements RequiredReductionCard {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.REQUIRED_REDUCTION_CARD;
	}
		...
		if (cardClass != null && cardClass.eIsProxy()) {
			...
			if (cardClass != oldCardClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.REQUIRED_REDUCTION_CARD__CARD_CLASS, oldCardClass, cardClass));
			}
		}
		return cardClass;
	}
	...
	public void setCardClass(ServiceClass newCardClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.REQUIRED_REDUCTION_CARD__CARD_CLASS, oldCardClass, cardClass));
	}
	...
	public ReductionCard getCard() {
		if (card != null && card.eIsProxy()) {
			...
			if (card != oldCard) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.REQUIRED_REDUCTION_CARD__CARD, oldCard, card));
			}
		}
		return card;
	}
	...
	public void setCard(ReductionCard newCard) {
		...
		card = newCard;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.REQUIRED_REDUCTION_CARD__CARD, oldCard, card));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.REQUIRED_REDUCTION_CARD__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.REQUIRED_REDUCTION_CARD__CARD_CLASS:
				if (resolve) return getCardClass();
				return basicGetCardClass();
			case AccountingPackage.REQUIRED_REDUCTION_CARD__CARD:
				if (resolve) return getCard();
				return basicGetCard();
			case AccountingPackage.REQUIRED_REDUCTION_CARD__NAME:
				return getName();
		}
