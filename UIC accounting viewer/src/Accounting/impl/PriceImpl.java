 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.PriceImpl#getId <em>Id</em>}</li>
 *   <li>{@link Accounting.impl.PriceImpl#getCurrencies <em>Currencies</em>}</li>
 *   <li>{@link Accounting.impl.PriceImpl#getDataSource <em>Data Source</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PriceImpl extends MinimalEObjectImpl.Container implements Price {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.PRICE;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.PRICE__ID, oldId, id));
	}
	...
	public void setDataSource(DataSource newDataSource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.PRICE__DATA_SOURCE, oldDataSource, dataSource));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AccountingPackage.PRICE__CURRENCIES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.PRICE__ID:
				return getId();
			case AccountingPackage.PRICE__CURRENCIES:
				return getCurrencies();
			case AccountingPackage.PRICE__DATA_SOURCE:
