 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.ValidityRangeImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link Accounting.impl.ValidityRangeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link Accounting.impl.ValidityRangeImpl#getHoursAfterMidnight <em>Hours After Midnight</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ValidityRangeImpl extends MinimalEObjectImpl.Container implements ValidityRange {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.VALIDITY_RANGE;
	}
	...
	public void setUnit(TimeUnit newUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.VALIDITY_RANGE__UNIT, oldUnit, unit));
	}
	...
	public void setValue(float newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.VALIDITY_RANGE__VALUE, oldValue, value));
	}
	...
	public void setHoursAfterMidnight(float newHoursAfterMidnight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.VALIDITY_RANGE__HOURS_AFTER_MIDNIGHT, oldHoursAfterMidnight, hoursAfterMidnight));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.VALIDITY_RANGE__UNIT:
				return getUnit();
			case AccountingPackage.VALIDITY_RANGE__VALUE:
				return getValue();
			case AccountingPackage.VALIDITY_RANGE__HOURS_AFTER_MIDNIGHT:
