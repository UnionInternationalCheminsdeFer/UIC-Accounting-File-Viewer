 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.CurrencyImpl#getName <em>Name</em>}</li>
 *   <li>{@link Accounting.impl.CurrencyImpl#getIsoCode <em>Iso Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CurrencyImpl extends MinimalEObjectImpl.Container implements Currency {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.CURRENCY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.CURRENCY__NAME, oldName, name));
	}
	...
	public void setIsoCode(String newIsoCode) {
		...
		isoCode = newIsoCode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.CURRENCY__ISO_CODE, oldIsoCode, isoCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.CURRENCY__NAME:
				return getName();
			case AccountingPackage.CURRENCY__ISO_CODE:
				return getIsoCode();
		}
