 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.RegionalConstraintImpl#getId <em>Id</em>}</li>
 *   <li>{@link Accounting.impl.RegionalConstraintImpl#getDistance <em>Distance</em>}</li>
 *   <li>{@link Accounting.impl.RegionalConstraintImpl#getEntryConnectionPoint <em>Entry Connection Point</em>}</li>
 *   <li>{@link Accounting.impl.RegionalConstraintImpl#getExitConnectionPoint <em>Exit Connection Point</em>}</li>
 *   <li>{@link Accounting.impl.RegionalConstraintImpl#getRegionalValidity <em>Regional Validity</em>}</li>
 *   <li>{@link Accounting.impl.RegionalConstraintImpl#getDataSource <em>Data Source</em>}</li>
 *   <li>{@link Accounting.impl.RegionalConstraintImpl#getDataDescription <em>Data Description</em>}</li>
 *   <li>{@link Accounting.impl.RegionalConstraintImpl#getLinkedFares <em>Linked Fares</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RegionalConstraintImpl extends MinimalEObjectImpl.Container implements RegionalConstraint {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.REGIONAL_CONSTRAINT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.REGIONAL_CONSTRAINT__ID, oldId, id));
	}
	...
	public void setDistance(float newDistance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.REGIONAL_CONSTRAINT__DISTANCE, oldDistance, distance));
	}
	...
	public ConnectionPoint getEntryConnectionPoint() {
		if (entryConnectionPoint != null && entryConnectionPoint.eIsProxy()) {
			...
			if (entryConnectionPoint != oldEntryConnectionPoint) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.REGIONAL_CONSTRAINT__ENTRY_CONNECTION_POINT, oldEntryConnectionPoint, entryConnectionPoint));
			}
		}
	...
	public void setEntryConnectionPoint(ConnectionPoint newEntryConnectionPoint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.REGIONAL_CONSTRAINT__ENTRY_CONNECTION_POINT, oldEntryConnectionPoint, entryConnectionPoint));
	}
	...
	public ConnectionPoint getExitConnectionPoint() {
		if (exitConnectionPoint != null && exitConnectionPoint.eIsProxy()) {
			...
			if (exitConnectionPoint != oldExitConnectionPoint) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.REGIONAL_CONSTRAINT__EXIT_CONNECTION_POINT, oldExitConnectionPoint, exitConnectionPoint));
			}
		}
	...
	public void setExitConnectionPoint(ConnectionPoint newExitConnectionPoint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.REGIONAL_CONSTRAINT__EXIT_CONNECTION_POINT, oldExitConnectionPoint, exitConnectionPoint));
	}
	...
	public void setDataSource(DataSource newDataSource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.REGIONAL_CONSTRAINT__DATA_SOURCE, oldDataSource, dataSource));
	}
	...
	public void setDataDescription(String newDataDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.REGIONAL_CONSTRAINT__DATA_DESCRIPTION, oldDataDescription, dataDescription));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AccountingPackage.REGIONAL_CONSTRAINT__REGIONAL_VALIDITY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.REGIONAL_CONSTRAINT__ID:
				return getId();
			case AccountingPackage.REGIONAL_CONSTRAINT__DISTANCE:
				return getDistance();
			case AccountingPackage.REGIONAL_CONSTRAINT__ENTRY_CONNECTION_POINT:
				if (resolve) return getEntryConnectionPoint();
				return basicGetEntryConnectionPoint();
			case AccountingPackage.REGIONAL_CONSTRAINT__EXIT_CONNECTION_POINT:
				if (resolve) return getExitConnectionPoint();
				return basicGetExitConnectionPoint();
			case AccountingPackage.REGIONAL_CONSTRAINT__REGIONAL_VALIDITY:
				return getRegionalValidity();
			case AccountingPackage.REGIONAL_CONSTRAINT__DATA_SOURCE:
				return getDataSource();
			case AccountingPackage.REGIONAL_CONSTRAINT__DATA_DESCRIPTION:
				return getDataDescription();
			case AccountingPackage.REGIONAL_CONSTRAINT__LINKED_FARES:
