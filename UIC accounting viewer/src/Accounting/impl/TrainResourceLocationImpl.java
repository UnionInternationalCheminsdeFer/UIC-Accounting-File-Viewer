...
import Accounting.TrainResourceLocation;
 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.TrainResourceLocationImpl#getCarrier <em>Carrier</em>}</li>
 *   <li>{@link Accounting.impl.TrainResourceLocationImpl#getOnlineResources <em>Online Resources</em>}</li>
 *   <li>{@link Accounting.impl.TrainResourceLocationImpl#getTrainId <em>Train Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TrainResourceLocationImpl extends MinimalEObjectImpl.Container implements TrainResourceLocation {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.TRAIN_RESOURCE_LOCATION;
	}
		...
		if (carrier != null && carrier.eIsProxy()) {
			...
			if (carrier != oldCarrier) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.TRAIN_RESOURCE_LOCATION__CARRIER, oldCarrier, carrier));
			}
		}
		return carrier;
	}
	...
	public void setCarrier(Carrier newCarrier) {
		...
		carrier = newCarrier;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TRAIN_RESOURCE_LOCATION__CARRIER, oldCarrier, carrier));
	}
	...
	public void setTrainId(String newTrainId) {
		...
		trainId = newTrainId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TRAIN_RESOURCE_LOCATION__TRAIN_ID, oldTrainId, trainId));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AccountingPackage.TRAIN_RESOURCE_LOCATION__ONLINE_RESOURCES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.TRAIN_RESOURCE_LOCATION__CARRIER:
				if (resolve) return getCarrier();
				return basicGetCarrier();
			case AccountingPackage.TRAIN_RESOURCE_LOCATION__ONLINE_RESOURCES:
				return getOnlineResources();
			case AccountingPackage.TRAIN_RESOURCE_LOCATION__TRAIN_ID:
				return getTrainId();
		}
