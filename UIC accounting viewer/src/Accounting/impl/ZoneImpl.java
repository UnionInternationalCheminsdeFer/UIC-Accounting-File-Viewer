 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.ZoneImpl#getBinaryZoneId <em>Binary Zone Id</em>}</li>
 *   <li>{@link Accounting.impl.ZoneImpl#getZoneId <em>Zone Id</em>}</li>
 *   <li>{@link Accounting.impl.ZoneImpl#getCity <em>City</em>}</li>
 *   <li>{@link Accounting.impl.ZoneImpl#getCarrier <em>Carrier</em>}</li>
 *   <li>{@link Accounting.impl.ZoneImpl#getEntryStation <em>Entry Station</em>}</li>
 *   <li>{@link Accounting.impl.ZoneImpl#getTerminalStation <em>Terminal Station</em>}</li>
 *   <li>{@link Accounting.impl.ZoneImpl#getNutsCode <em>Nuts Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ZoneImpl extends MinimalEObjectImpl.Container implements Zone {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.ZONE;
	}
	...
	public void setBinaryZoneId(byte[] newBinaryZoneId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.ZONE__BINARY_ZONE_ID, oldBinaryZoneId, binaryZoneId));
	}
	...
	public void setCity(int newCity) {
		...
		city = newCity;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.ZONE__CITY, oldCity, city));
	}
	...
	public Carrier getCarrier() {
		if (carrier != null && carrier.eIsProxy()) {
			...
			if (carrier != oldCarrier) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.ZONE__CARRIER, oldCarrier, carrier));
			}
		}
		return carrier;
	}
	...
	public void setCarrier(Carrier newCarrier) {
		...
		carrier = newCarrier;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.ZONE__CARRIER, oldCarrier, carrier));
	}
	...
	public Station getEntryStation() {
		if (entryStation != null && entryStation.eIsProxy()) {
			...
			if (entryStation != oldEntryStation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.ZONE__ENTRY_STATION, oldEntryStation, entryStation));
			}
		}
		return entryStation;
	}
	...
	public void setEntryStation(Station newEntryStation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.ZONE__ENTRY_STATION, oldEntryStation, entryStation));
	}
	...
	public Station getTerminalStation() {
		if (terminalStation != null && terminalStation.eIsProxy()) {
			...
			if (terminalStation != oldTerminalStation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.ZONE__TERMINAL_STATION, oldTerminalStation, terminalStation));
			}
		}
	...
	public void setTerminalStation(Station newTerminalStation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.ZONE__TERMINAL_STATION, oldTerminalStation, terminalStation));
	}
	...
	public NutsCode getNutsCode() {
		if (nutsCode != null && nutsCode.eIsProxy()) {
			...
			if (nutsCode != oldNutsCode) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.ZONE__NUTS_CODE, oldNutsCode, nutsCode));
			}
		}
		return nutsCode;
	}
	...
	public void setNutsCode(NutsCode newNutsCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.ZONE__NUTS_CODE, oldNutsCode, nutsCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.ZONE__BINARY_ZONE_ID:
				return getBinaryZoneId();
			case AccountingPackage.ZONE__ZONE_ID:
				return getZoneId();
			case AccountingPackage.ZONE__CITY:
				return getCity();
			case AccountingPackage.ZONE__CARRIER:
				if (resolve) return getCarrier();
				return basicGetCarrier();
			case AccountingPackage.ZONE__ENTRY_STATION:
				if (resolve) return getEntryStation();
				return basicGetEntryStation();
			case AccountingPackage.ZONE__TERMINAL_STATION:
				if (resolve) return getTerminalStation();
				return basicGetTerminalStation();
			case AccountingPackage.ZONE__NUTS_CODE:
