...
import Accounting.TimeRange;
import Accounting.TimeRangeScope;
 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.TimeRangeImpl#getScope <em>Scope</em>}</li>
 *   <li>{@link Accounting.impl.TimeRangeImpl#getFrom <em>From</em>}</li>
 *   <li>{@link Accounting.impl.TimeRangeImpl#getUntil <em>Until</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeRangeImpl extends MinimalEObjectImpl.Container implements TimeRange {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.TIME_RANGE;
	}
	...
	public void setScope(TimeRangeScope newScope) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TIME_RANGE__SCOPE, oldScope, scope));
	}
	...
	public void setFrom(int newFrom) {
		...
		from = newFrom;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TIME_RANGE__FROM, oldFrom, from));
	}
	...
	public void setUntil(int newUntil) {
		...
		until = newUntil;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TIME_RANGE__UNTIL, oldUntil, until));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.TIME_RANGE__SCOPE:
				return getScope();
			case AccountingPackage.TIME_RANGE__FROM:
				return getFrom();
			case AccountingPackage.TIME_RANGE__UNTIL:
				return getUntil();
		}
