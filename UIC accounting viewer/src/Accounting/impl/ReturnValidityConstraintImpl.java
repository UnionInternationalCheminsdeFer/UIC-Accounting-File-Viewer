 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.ReturnValidityConstraintImpl#getExcludedWeekdays <em>Excluded Weekdays</em>}</li>
 *   <li>{@link Accounting.impl.ReturnValidityConstraintImpl#getLatestReturn <em>Latest Return</em>}</li>
 *   <li>{@link Accounting.impl.ReturnValidityConstraintImpl#getEarliestReturn <em>Earliest Return</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReturnValidityConstraintImpl extends MinimalEObjectImpl.Container implements ReturnValidityConstraint {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.RETURN_VALIDITY_CONSTRAINT;
	}
	...
	public void setLatestReturn(int newLatestReturn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.RETURN_VALIDITY_CONSTRAINT__LATEST_RETURN, oldLatestReturn, latestReturn));
	}
	...
	public void setEarliestReturn(int newEarliestReturn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.RETURN_VALIDITY_CONSTRAINT__EARLIEST_RETURN, oldEarliestReturn, earliestReturn));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.RETURN_VALIDITY_CONSTRAINT__EXCLUDED_WEEKDAYS:
				return getExcludedWeekdays();
			case AccountingPackage.RETURN_VALIDITY_CONSTRAINT__LATEST_RETURN:
				return getLatestReturn();
			case AccountingPackage.RETURN_VALIDITY_CONSTRAINT__EARLIEST_RETURN:
