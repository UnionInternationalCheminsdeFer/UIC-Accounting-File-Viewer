...
import Accounting.InterfaceType;
import Accounting.OfferRequestType;
 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.OnlineResourceImpl#getOfferRequestType <em>Offer Request Type</em>}</li>
 *   <li>{@link Accounting.impl.OnlineResourceImpl#getInterfaceType <em>Interface Type</em>}</li>
 *   <li>{@link Accounting.impl.OnlineResourceImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link Accounting.impl.OnlineResourceImpl#getSystem <em>System</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OnlineResourceImpl extends MinimalEObjectImpl.Container implements OnlineResource {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.ONLINE_RESOURCE;
	}
	...
	public void setOfferRequestType(OfferRequestType newOfferRequestType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.ONLINE_RESOURCE__OFFER_REQUEST_TYPE, oldOfferRequestType, offerRequestType));
	}
	...
	public void setInterfaceType(InterfaceType newInterfaceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.ONLINE_RESOURCE__INTERFACE_TYPE, oldInterfaceType, interfaceType));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.ONLINE_RESOURCE__VERSION, oldVersion, version));
	}
	...
	public void setSystem(String newSystem) {
		...
		system = newSystem;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.ONLINE_RESOURCE__SYSTEM, oldSystem, system));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.ONLINE_RESOURCE__OFFER_REQUEST_TYPE:
				return getOfferRequestType();
			case AccountingPackage.ONLINE_RESOURCE__INTERFACE_TYPE:
				return getInterfaceType();
			case AccountingPackage.ONLINE_RESOURCE__VERSION:
				return getVersion();
			case AccountingPackage.ONLINE_RESOURCE__SYSTEM:
				return getSystem();
		}
