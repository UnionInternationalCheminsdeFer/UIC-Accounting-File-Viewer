...
import Accounting.AllowedPersonalDataChanges;
import Accounting.PersonalDataChangeReason;
 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.AllowedPersonalDataChangesImpl#getTimeLimit <em>Time Limit</em>}</li>
 *   <li>{@link Accounting.impl.AllowedPersonalDataChangesImpl#getAcceptedReason <em>Accepted Reason</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AllowedPersonalDataChangesImpl extends MinimalEObjectImpl.Container implements AllowedPersonalDataChanges {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.ALLOWED_PERSONAL_DATA_CHANGES;
	}
	...
	public void setTimeLimit(float newTimeLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.ALLOWED_PERSONAL_DATA_CHANGES__TIME_LIMIT, oldTimeLimit, timeLimit));
	}
	...
	public void setAcceptedReason(PersonalDataChangeReason newAcceptedReason) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.ALLOWED_PERSONAL_DATA_CHANGES__ACCEPTED_REASON, oldAcceptedReason, acceptedReason));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.ALLOWED_PERSONAL_DATA_CHANGES__TIME_LIMIT:
				return getTimeLimit();
			case AccountingPackage.ALLOWED_PERSONAL_DATA_CHANGES__ACCEPTED_REASON:
