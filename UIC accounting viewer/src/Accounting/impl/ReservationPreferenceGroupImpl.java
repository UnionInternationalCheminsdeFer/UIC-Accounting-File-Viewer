 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.ReservationPreferenceGroupImpl#getPreference <em>Preference</em>}</li>
 *   <li>{@link Accounting.impl.ReservationPreferenceGroupImpl#getGroup <em>Group</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReservationPreferenceGroupImpl extends MinimalEObjectImpl.Container implements ReservationPreferenceGroup {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.RESERVATION_PREFERENCE_GROUP;
	}
	...
	public void setGroup(String newGroup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.RESERVATION_PREFERENCE_GROUP__GROUP, oldGroup, group));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.RESERVATION_PREFERENCE_GROUP__PREFERENCE:
				return getPreference();
			case AccountingPackage.RESERVATION_PREFERENCE_GROUP__GROUP:
				return getGroup();
		}
