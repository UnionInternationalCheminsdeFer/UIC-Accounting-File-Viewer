 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.FareConstraintBundleImpl#getId <em>Id</em>}</li>
 *   <li>{@link Accounting.impl.FareConstraintBundleImpl#getDefaultFareType <em>Default Fare Type</em>}</li>
 *   <li>{@link Accounting.impl.FareConstraintBundleImpl#getDataDescription <em>Data Description</em>}</li>
 *   <li>{@link Accounting.impl.FareConstraintBundleImpl#getCarrierConstraint <em>Carrier Constraint</em>}</li>
 *   <li>{@link Accounting.impl.FareConstraintBundleImpl#getSalesAvailability <em>Sales Availability</em>}</li>
 *   <li>{@link Accounting.impl.FareConstraintBundleImpl#getTravelValidity <em>Travel Validity</em>}</li>
 *   <li>{@link Accounting.impl.FareConstraintBundleImpl#getCombinationConstraint <em>Combination Constraint</em>}</li>
 *   <li>{@link Accounting.impl.FareConstraintBundleImpl#getPersonalDataConstraint <em>Personal Data Constraint</em>}</li>
 *   <li>{@link Accounting.impl.FareConstraintBundleImpl#getFulfillmentConstraint <em>Fulfillment Constraint</em>}</li>
 *   <li>{@link Accounting.impl.FareConstraintBundleImpl#getTotalPassengerConstraint <em>Total Passenger Constraint</em>}</li>
 *   <li>{@link Accounting.impl.FareConstraintBundleImpl#getDefaultRegulatoryConditions <em>Default Regulatory Conditions</em>}</li>
 *   <li>{@link Accounting.impl.FareConstraintBundleImpl#getDataSource <em>Data Source</em>}</li>
 *   <li>{@link Accounting.impl.FareConstraintBundleImpl#getConvertedBundles <em>Converted Bundles</em>}</li>
 *   <li>{@link Accounting.impl.FareConstraintBundleImpl#getLuggageConstraint <em>Luggage Constraint</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FareConstraintBundleImpl extends MinimalEObjectImpl.Container implements FareConstraintBundle {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.FARE_CONSTRAINT_BUNDLE;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_CONSTRAINT_BUNDLE__ID, oldId, id));
	}
	...
	public void setDefaultFareType(FareType newDefaultFareType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_CONSTRAINT_BUNDLE__DEFAULT_FARE_TYPE, oldDefaultFareType, defaultFareType));
	}
	...
	public void setDataDescription(String newDataDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_CONSTRAINT_BUNDLE__DATA_DESCRIPTION, oldDataDescription, dataDescription));
	}
	...
	public CarrierConstraint getCarrierConstraint() {
		if (carrierConstraint != null && carrierConstraint.eIsProxy()) {
			...
			if (carrierConstraint != oldCarrierConstraint) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.FARE_CONSTRAINT_BUNDLE__CARRIER_CONSTRAINT, oldCarrierConstraint, carrierConstraint));
			}
		}
	...
	public void setCarrierConstraint(CarrierConstraint newCarrierConstraint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_CONSTRAINT_BUNDLE__CARRIER_CONSTRAINT, oldCarrierConstraint, carrierConstraint));
	}
	...
	public SalesAvailabilityConstraint getSalesAvailability() {
		if (salesAvailability != null && salesAvailability.eIsProxy()) {
			...
			if (salesAvailability != oldSalesAvailability) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.FARE_CONSTRAINT_BUNDLE__SALES_AVAILABILITY, oldSalesAvailability, salesAvailability));
			}
		}
	...
	public void setSalesAvailability(SalesAvailabilityConstraint newSalesAvailability) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_CONSTRAINT_BUNDLE__SALES_AVAILABILITY, oldSalesAvailability, salesAvailability));
	}
	...
	public TravelValidityConstraint getTravelValidity() {
		if (travelValidity != null && travelValidity.eIsProxy()) {
			...
			if (travelValidity != oldTravelValidity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.FARE_CONSTRAINT_BUNDLE__TRAVEL_VALIDITY, oldTravelValidity, travelValidity));
			}
		}
	...
	public void setTravelValidity(TravelValidityConstraint newTravelValidity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_CONSTRAINT_BUNDLE__TRAVEL_VALIDITY, oldTravelValidity, travelValidity));
	}
	...
	public CombinationConstraint getCombinationConstraint() {
		if (combinationConstraint != null && combinationConstraint.eIsProxy()) {
			...
			if (combinationConstraint != oldCombinationConstraint) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.FARE_CONSTRAINT_BUNDLE__COMBINATION_CONSTRAINT, oldCombinationConstraint, combinationConstraint));
			}
		}
	...
	public void setCombinationConstraint(CombinationConstraint newCombinationConstraint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_CONSTRAINT_BUNDLE__COMBINATION_CONSTRAINT, oldCombinationConstraint, combinationConstraint));
	}
	...
	public PersonalDataConstraint getPersonalDataConstraint() {
		if (personalDataConstraint != null && personalDataConstraint.eIsProxy()) {
			...
			if (personalDataConstraint != oldPersonalDataConstraint) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.FARE_CONSTRAINT_BUNDLE__PERSONAL_DATA_CONSTRAINT, oldPersonalDataConstraint, personalDataConstraint));
			}
		}
	...
	public void setPersonalDataConstraint(PersonalDataConstraint newPersonalDataConstraint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_CONSTRAINT_BUNDLE__PERSONAL_DATA_CONSTRAINT, oldPersonalDataConstraint, personalDataConstraint));
	}
	...
	public FulfillmentConstraint getFulfillmentConstraint() {
		if (fulfillmentConstraint != null && fulfillmentConstraint.eIsProxy()) {
			...
			if (fulfillmentConstraint != oldFulfillmentConstraint) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.FARE_CONSTRAINT_BUNDLE__FULFILLMENT_CONSTRAINT, oldFulfillmentConstraint, fulfillmentConstraint));
			}
		}
	...
	public void setFulfillmentConstraint(FulfillmentConstraint newFulfillmentConstraint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_CONSTRAINT_BUNDLE__FULFILLMENT_CONSTRAINT, oldFulfillmentConstraint, fulfillmentConstraint));
	}
	...
	public TotalPassengerCombinationConstraint getTotalPassengerConstraint() {
		if (totalPassengerConstraint != null && totalPassengerConstraint.eIsProxy()) {
			...
			if (totalPassengerConstraint != oldTotalPassengerConstraint) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.FARE_CONSTRAINT_BUNDLE__TOTAL_PASSENGER_CONSTRAINT, oldTotalPassengerConstraint, totalPassengerConstraint));
			}
		}
	...
	public void setTotalPassengerConstraint(TotalPassengerCombinationConstraint newTotalPassengerConstraint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_CONSTRAINT_BUNDLE__TOTAL_PASSENGER_CONSTRAINT, oldTotalPassengerConstraint, totalPassengerConstraint));
	}
	...
	public void setDataSource(DataSource newDataSource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_CONSTRAINT_BUNDLE__DATA_SOURCE, oldDataSource, dataSource));
	}
	...
	public LuggageConstraint getLuggageConstraint() {
		if (luggageConstraint != null && luggageConstraint.eIsProxy()) {
			...
			if (luggageConstraint != oldLuggageConstraint) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.FARE_CONSTRAINT_BUNDLE__LUGGAGE_CONSTRAINT, oldLuggageConstraint, luggageConstraint));
			}
		}
	...
	public void setLuggageConstraint(LuggageConstraint newLuggageConstraint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_CONSTRAINT_BUNDLE__LUGGAGE_CONSTRAINT, oldLuggageConstraint, luggageConstraint));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case AccountingPackage.FARE_CONSTRAINT_BUNDLE__CARRIER_CONSTRAINT:
				if (resolve) return getCarrierConstraint();
				return basicGetCarrierConstraint();
			case AccountingPackage.FARE_CONSTRAINT_BUNDLE__SALES_AVAILABILITY:
				if (resolve) return getSalesAvailability();
				return basicGetSalesAvailability();
			case AccountingPackage.FARE_CONSTRAINT_BUNDLE__TRAVEL_VALIDITY:
				if (resolve) return getTravelValidity();
				return basicGetTravelValidity();
			case AccountingPackage.FARE_CONSTRAINT_BUNDLE__COMBINATION_CONSTRAINT:
				if (resolve) return getCombinationConstraint();
				return basicGetCombinationConstraint();
			case AccountingPackage.FARE_CONSTRAINT_BUNDLE__PERSONAL_DATA_CONSTRAINT:
				if (resolve) return getPersonalDataConstraint();
				return basicGetPersonalDataConstraint();
			case AccountingPackage.FARE_CONSTRAINT_BUNDLE__FULFILLMENT_CONSTRAINT:
				if (resolve) return getFulfillmentConstraint();
				return basicGetFulfillmentConstraint();
			case AccountingPackage.FARE_CONSTRAINT_BUNDLE__TOTAL_PASSENGER_CONSTRAINT:
			...
			case AccountingPackage.FARE_CONSTRAINT_BUNDLE__CONVERTED_BUNDLES:
				return getConvertedBundles();
			case AccountingPackage.FARE_CONSTRAINT_BUNDLE__LUGGAGE_CONSTRAINT:
