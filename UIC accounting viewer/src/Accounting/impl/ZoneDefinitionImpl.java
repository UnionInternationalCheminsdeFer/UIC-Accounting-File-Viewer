...
import Accounting.StationSet;
import Accounting.ZoneDefinition;
 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.ZoneDefinitionImpl#getProvider <em>Provider</em>}</li>
 *   <li>{@link Accounting.impl.ZoneDefinitionImpl#getZoneId <em>Zone Id</em>}</li>
 *   <li>{@link Accounting.impl.ZoneDefinitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link Accounting.impl.ZoneDefinitionImpl#getPolygone <em>Polygone</em>}</li>
 *   <li>{@link Accounting.impl.ZoneDefinitionImpl#getNameUtf8 <em>Name Utf8</em>}</li>
 *   <li>{@link Accounting.impl.ZoneDefinitionImpl#getStationSet <em>Station Set</em>}</li>
 *   <li>{@link Accounting.impl.ZoneDefinitionImpl#getNutsCodes <em>Nuts Codes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ZoneDefinitionImpl extends MinimalEObjectImpl.Container implements ZoneDefinition {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.ZONE_DEFINITION;
	}
		...
		if (provider != null && provider.eIsProxy()) {
			...
			if (provider != oldProvider) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.ZONE_DEFINITION__PROVIDER, oldProvider, provider));
			}
		}
		return provider;
	}
	...
	public void setProvider(Carrier newProvider) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.ZONE_DEFINITION__PROVIDER, oldProvider, provider));
	}
	...
	public void setZoneId(String newZoneId) {
		...
		zoneId = newZoneId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.ZONE_DEFINITION__ZONE_ID, oldZoneId, zoneId));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.ZONE_DEFINITION__NAME, oldName, name));
	}
	...
	public NotificationChain basicSetPolygone(Polygone newPolygone, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.ZONE_DEFINITION__POLYGONE, oldPolygone, newPolygone);
	...
	public void setPolygone(Polygone newPolygone) {
		if (newPolygone != polygone) {
			...
			if (polygone != null)
				msgs = ((InternalEObject)polygone).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.ZONE_DEFINITION__POLYGONE, null, msgs);
			if (newPolygone != null)
				msgs = ((InternalEObject)newPolygone).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.ZONE_DEFINITION__POLYGONE, null, msgs);
			msgs = basicSetPolygone(newPolygone, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.ZONE_DEFINITION__POLYGONE, newPolygone, newPolygone));
	}
	...
	public void setNameUtf8(String newNameUtf8) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.ZONE_DEFINITION__NAME_UTF8, oldNameUtf8, nameUtf8));
	}
	...
	public NotificationChain basicSetStationSet(StationSet newStationSet, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.ZONE_DEFINITION__STATION_SET, oldStationSet, newStationSet);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStationSet(StationSet newStationSet) {
		if (newStationSet != stationSet) {
			NotificationChain msgs = null;
			if (stationSet != null)
				msgs = ((InternalEObject)stationSet).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.ZONE_DEFINITION__STATION_SET, null, msgs);
			if (newStationSet != null)
				msgs = ((InternalEObject)newStationSet).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.ZONE_DEFINITION__STATION_SET, null, msgs);
			msgs = basicSetStationSet(newStationSet, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.ZONE_DEFINITION__STATION_SET, newStationSet, newStationSet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AccountingPackage.ZONE_DEFINITION__POLYGONE:
				return basicSetPolygone(null, msgs);
			case AccountingPackage.ZONE_DEFINITION__STATION_SET:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.ZONE_DEFINITION__PROVIDER:
				if (resolve) return getProvider();
				return basicGetProvider();
			case AccountingPackage.ZONE_DEFINITION__ZONE_ID:
				return getZoneId();
			case AccountingPackage.ZONE_DEFINITION__NAME:
				return getName();
			case AccountingPackage.ZONE_DEFINITION__POLYGONE:
				return getPolygone();
			case AccountingPackage.ZONE_DEFINITION__NAME_UTF8:
				return getNameUtf8();
			case AccountingPackage.ZONE_DEFINITION__STATION_SET:
				return getStationSet();
			case AccountingPackage.ZONE_DEFINITION__NUTS_CODES:
				return getNutsCodes();
		}
