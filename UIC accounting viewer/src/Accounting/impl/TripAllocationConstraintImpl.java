...
import Accounting.TripAllocationProcess;
import Accounting.TripAllocationUnit;
 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.TripAllocationConstraintImpl#getAllocationUnit <em>Allocation Unit</em>}</li>
 *   <li>{@link Accounting.impl.TripAllocationConstraintImpl#getMaxUnits <em>Max Units</em>}</li>
 *   <li>{@link Accounting.impl.TripAllocationConstraintImpl#getDurationUnit <em>Duration Unit</em>}</li>
 *   <li>{@link Accounting.impl.TripAllocationConstraintImpl#getRequiredProcesses <em>Required Processes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TripAllocationConstraintImpl extends MinimalEObjectImpl.Container implements TripAllocationConstraint {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.TRIP_ALLOCATION_CONSTRAINT;
	}
	...
	public void setAllocationUnit(TripAllocationUnit newAllocationUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TRIP_ALLOCATION_CONSTRAINT__ALLOCATION_UNIT, oldAllocationUnit, allocationUnit));
	}
	...
	public void setMaxUnits(int newMaxUnits) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TRIP_ALLOCATION_CONSTRAINT__MAX_UNITS, oldMaxUnits, maxUnits));
	}
	...
	public void setDurationUnit(String newDurationUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TRIP_ALLOCATION_CONSTRAINT__DURATION_UNIT, oldDurationUnit, durationUnit));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.TRIP_ALLOCATION_CONSTRAINT__ALLOCATION_UNIT:
				return getAllocationUnit();
			case AccountingPackage.TRIP_ALLOCATION_CONSTRAINT__MAX_UNITS:
				return getMaxUnits();
			case AccountingPackage.TRIP_ALLOCATION_CONSTRAINT__DURATION_UNIT:
				return getDurationUnit();
			case AccountingPackage.TRIP_ALLOCATION_CONSTRAINT__REQUIRED_PROCESSES:
