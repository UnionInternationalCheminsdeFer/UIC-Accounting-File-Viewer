 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.RequiredBarcodesImpl#getRequiredBarcodes <em>Required Barcodes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequiredBarcodesImpl extends MinimalEObjectImpl.Container implements RequiredBarcodes {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.REQUIRED_BARCODES;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.REQUIRED_BARCODES__REQUIRED_BARCODES:
