 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.SalesAvailabilityConstraintImpl#getId <em>Id</em>}</li>
 *   <li>{@link Accounting.impl.SalesAvailabilityConstraintImpl#getDataDescription <em>Data Description</em>}</li>
 *   <li>{@link Accounting.impl.SalesAvailabilityConstraintImpl#getRestrictions <em>Restrictions</em>}</li>
 *   <li>{@link Accounting.impl.SalesAvailabilityConstraintImpl#getDataSource <em>Data Source</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SalesAvailabilityConstraintImpl extends MinimalEObjectImpl.Container implements SalesAvailabilityConstraint {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.SALES_AVAILABILITY_CONSTRAINT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.SALES_AVAILABILITY_CONSTRAINT__ID, oldId, id));
	}
	...
	public void setDataDescription(String newDataDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.SALES_AVAILABILITY_CONSTRAINT__DATA_DESCRIPTION, oldDataDescription, dataDescription));
	}
	...
	public void setDataSource(DataSource newDataSource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.SALES_AVAILABILITY_CONSTRAINT__DATA_SOURCE, oldDataSource, dataSource));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AccountingPackage.SALES_AVAILABILITY_CONSTRAINT__RESTRICTIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.SALES_AVAILABILITY_CONSTRAINT__ID:
				return getId();
			case AccountingPackage.SALES_AVAILABILITY_CONSTRAINT__DATA_DESCRIPTION:
				return getDataDescription();
			case AccountingPackage.SALES_AVAILABILITY_CONSTRAINT__RESTRICTIONS:
				return getRestrictions();
			case AccountingPackage.SALES_AVAILABILITY_CONSTRAINT__DATA_SOURCE:
