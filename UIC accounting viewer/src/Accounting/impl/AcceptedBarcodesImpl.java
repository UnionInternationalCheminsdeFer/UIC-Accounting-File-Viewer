 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.AcceptedBarcodesImpl#getAcceptedBarcodes <em>Accepted Barcodes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AcceptedBarcodesImpl extends MinimalEObjectImpl.Container implements AcceptedBarcodes {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.ACCEPTED_BARCODES;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.ACCEPTED_BARCODES__ACCEPTED_BARCODES:
