 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.ServiceClassImpl#getId <em>Id</em>}</li>
 *   <li>{@link Accounting.impl.ServiceClassImpl#getClassicClass <em>Classic Class</em>}</li>
 *   <li>{@link Accounting.impl.ServiceClassImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ServiceClassImpl extends MinimalEObjectImpl.Container implements ServiceClass {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.SERVICE_CLASS;
	}
	...
	public void setId(ClassId newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.SERVICE_CLASS__ID, oldId, id));
	}
	...
	public void setClassicClass(ClassicClassType newClassicClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.SERVICE_CLASS__CLASSIC_CLASS, oldClassicClass, classicClass));
	}
	...
	public Text getText() {
		if (text != null && text.eIsProxy()) {
			...
			if (text != oldText) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.SERVICE_CLASS__TEXT, oldText, text));
			}
		}
		return text;
	}
	...
	public void setText(Text newText) {
		...
		text = newText;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.SERVICE_CLASS__TEXT, oldText, text));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.SERVICE_CLASS__ID:
				return getId();
			case AccountingPackage.SERVICE_CLASS__CLASSIC_CLASS:
				return getClassicClass();
			case AccountingPackage.SERVICE_CLASS__TEXT:
