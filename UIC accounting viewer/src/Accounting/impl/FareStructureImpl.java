...
import Accounting.Calendars;
import Accounting.CarrierConstraints;
import Accounting.CombinationConstraints;
import Accounting.ConnectionPoints;
import Accounting.FareConstraintBundles;
import Accounting.FareElements;
import Accounting.FareResourceLocations;
import Accounting.FareStationSetDefinitions;
import Accounting.FareStructure;
import Accounting.FulfillmentConstraints;
import Accounting.LuggageConstraints;
import Accounting.PassengerConstraints;
import Accounting.PersonalDataConstraints;
import Accounting.Prices;
import Accounting.ReductionCards;
import Accounting.ReductionConstraints;
import Accounting.RegionalConstraints;
import Accounting.ReservationParameters;
import Accounting.SalesAvailabilityConstraints;
import Accounting.ServiceClassDefinitions;
import Accounting.ServiceConstraints;
import Accounting.ServiceLevelDefinitions;
import Accounting.StationNames;
import Accounting.SupportedOnlineServices;
import Accounting.Texts;
import Accounting.TotalPassengerCombinationConstraints;
import Accounting.TravelValidityConstraints;
import Accounting.ZoneDefinitions;
 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.FareStructureImpl#getServiceClassDefinitions <em>Service Class Definitions</em>}</li>
 *   <li>{@link Accounting.impl.FareStructureImpl#getServiceLevelDefinitions <em>Service Level Definitions</em>}</li>
 *   <li>{@link Accounting.impl.FareStructureImpl#getStationNames <em>Station Names</em>}</li>
 *   <li>{@link Accounting.impl.FareStructureImpl#getFareStationSetDefinitions <em>Fare Station Set Definitions</em>}</li>
 *   <li>{@link Accounting.impl.FareStructureImpl#getCalendars <em>Calendars</em>}</li>
 *   <li>{@link Accounting.impl.FareStructureImpl#getTexts <em>Texts</em>}</li>
 *   <li>{@link Accounting.impl.FareStructureImpl#getReductionCards <em>Reduction Cards</em>}</li>
 *   <li>{@link Accounting.impl.FareStructureImpl#getFareConstraintBundles <em>Fare Constraint Bundles</em>}</li>
 *   <li>{@link Accounting.impl.FareStructureImpl#getFareElements <em>Fare Elements</em>}</li>
 *   <li>{@link Accounting.impl.FareStructureImpl#getCombinationConstraints <em>Combination Constraints</em>}</li>
 *   <li>{@link Accounting.impl.FareStructureImpl#getSalesAvailabilityConstraints <em>Sales Availability Constraints</em>}</li>
 *   <li>{@link Accounting.impl.FareStructureImpl#getTravelValidityConstraints <em>Travel Validity Constraints</em>}</li>
 *   <li>{@link Accounting.impl.FareStructureImpl#getRegionalConstraints <em>Regional Constraints</em>}</li>
 *   <li>{@link Accounting.impl.FareStructureImpl#getConnectionPoints <em>Connection Points</em>}</li>
 *   <li>{@link Accounting.impl.FareStructureImpl#getCarrierConstraints <em>Carrier Constraints</em>}</li>
 *   <li>{@link Accounting.impl.FareStructureImpl#getServiceConstraints <em>Service Constraints</em>}</li>
 *   <li>{@link Accounting.impl.FareStructureImpl#getPassengerConstraints <em>Passenger Constraints</em>}</li>
 *   <li>{@link Accounting.impl.FareStructureImpl#getTotalPassengerCombinationConstraints <em>Total Passenger Combination Constraints</em>}</li>
 *   <li>{@link Accounting.impl.FareStructureImpl#getReductionConstraints <em>Reduction Constraints</em>}</li>
 *   <li>{@link Accounting.impl.FareStructureImpl#getPersonalDataConstraints <em>Personal Data Constraints</em>}</li>
 *   <li>{@link Accounting.impl.FareStructureImpl#getAfterSalesRules <em>After Sales Rules</em>}</li>
 *   <li>{@link Accounting.impl.FareStructureImpl#getPrices <em>Prices</em>}</li>
 *   <li>{@link Accounting.impl.FareStructureImpl#getFulfillmentConstraints <em>Fulfillment Constraints</em>}</li>
 *   <li>{@link Accounting.impl.FareStructureImpl#getReservationParameters <em>Reservation Parameters</em>}</li>
 *   <li>{@link Accounting.impl.FareStructureImpl#getSupportedOnlineServices <em>Supported Online Services</em>}</li>
 *   <li>{@link Accounting.impl.FareStructureImpl#getFareResourceLocations <em>Fare Resource Locations</em>}</li>
 *   <li>{@link Accounting.impl.FareStructureImpl#getZoneDefinitions <em>Zone Definitions</em>}</li>
 *   <li>{@link Accounting.impl.FareStructureImpl#getLuggageConstraints <em>Luggage Constraints</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FareStructureImpl extends MinimalEObjectImpl.Container implements FareStructure {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.FARE_STRUCTURE;
	}
	...
	public NotificationChain basicSetServiceClassDefinitions(ServiceClassDefinitions newServiceClassDefinitions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__SERVICE_CLASS_DEFINITIONS, oldServiceClassDefinitions, newServiceClassDefinitions);
	...
	public void setServiceClassDefinitions(ServiceClassDefinitions newServiceClassDefinitions) {
		if (newServiceClassDefinitions != serviceClassDefinitions) {
			...
			if (serviceClassDefinitions != null)
				msgs = ((InternalEObject)serviceClassDefinitions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__SERVICE_CLASS_DEFINITIONS, null, msgs);
			if (newServiceClassDefinitions != null)
				msgs = ((InternalEObject)newServiceClassDefinitions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__SERVICE_CLASS_DEFINITIONS, null, msgs);
			msgs = basicSetServiceClassDefinitions(newServiceClassDefinitions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__SERVICE_CLASS_DEFINITIONS, newServiceClassDefinitions, newServiceClassDefinitions));
	}
	...
	public NotificationChain basicSetServiceLevelDefinitions(ServiceLevelDefinitions newServiceLevelDefinitions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__SERVICE_LEVEL_DEFINITIONS, oldServiceLevelDefinitions, newServiceLevelDefinitions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setServiceLevelDefinitions(ServiceLevelDefinitions newServiceLevelDefinitions) {
		if (newServiceLevelDefinitions != serviceLevelDefinitions) {
			...
			if (serviceLevelDefinitions != null)
				msgs = ((InternalEObject)serviceLevelDefinitions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__SERVICE_LEVEL_DEFINITIONS, null, msgs);
			if (newServiceLevelDefinitions != null)
				msgs = ((InternalEObject)newServiceLevelDefinitions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__SERVICE_LEVEL_DEFINITIONS, null, msgs);
			msgs = basicSetServiceLevelDefinitions(newServiceLevelDefinitions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__SERVICE_LEVEL_DEFINITIONS, newServiceLevelDefinitions, newServiceLevelDefinitions));
	}
	...
	public NotificationChain basicSetStationNames(StationNames newStationNames, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__STATION_NAMES, oldStationNames, newStationNames);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStationNames(StationNames newStationNames) {
		if (newStationNames != stationNames) {
			...
			if (stationNames != null)
				msgs = ((InternalEObject)stationNames).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__STATION_NAMES, null, msgs);
			if (newStationNames != null)
				msgs = ((InternalEObject)newStationNames).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__STATION_NAMES, null, msgs);
			msgs = basicSetStationNames(newStationNames, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__STATION_NAMES, newStationNames, newStationNames));
	}
	...
	public NotificationChain basicSetFareStationSetDefinitions(FareStationSetDefinitions newFareStationSetDefinitions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__FARE_STATION_SET_DEFINITIONS, oldFareStationSetDefinitions, newFareStationSetDefinitions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFareStationSetDefinitions(FareStationSetDefinitions newFareStationSetDefinitions) {
		if (newFareStationSetDefinitions != fareStationSetDefinitions) {
			...
			if (fareStationSetDefinitions != null)
				msgs = ((InternalEObject)fareStationSetDefinitions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__FARE_STATION_SET_DEFINITIONS, null, msgs);
			if (newFareStationSetDefinitions != null)
				msgs = ((InternalEObject)newFareStationSetDefinitions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__FARE_STATION_SET_DEFINITIONS, null, msgs);
			msgs = basicSetFareStationSetDefinitions(newFareStationSetDefinitions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__FARE_STATION_SET_DEFINITIONS, newFareStationSetDefinitions, newFareStationSetDefinitions));
	}
	...
	public NotificationChain basicSetCalendars(Calendars newCalendars, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__CALENDARS, oldCalendars, newCalendars);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCalendars(Calendars newCalendars) {
		if (newCalendars != calendars) {
			NotificationChain msgs = null;
			if (calendars != null)
				msgs = ((InternalEObject)calendars).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__CALENDARS, null, msgs);
			if (newCalendars != null)
				msgs = ((InternalEObject)newCalendars).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__CALENDARS, null, msgs);
			msgs = basicSetCalendars(newCalendars, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__CALENDARS, newCalendars, newCalendars));
	}
	...
	public NotificationChain basicSetTexts(Texts newTexts, NotificationChain msgs) {
		...
		texts = newTexts;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__TEXTS, oldTexts, newTexts);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTexts(Texts newTexts) {
		if (newTexts != texts) {
			NotificationChain msgs = null;
			if (texts != null)
				msgs = ((InternalEObject)texts).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__TEXTS, null, msgs);
			if (newTexts != null)
				msgs = ((InternalEObject)newTexts).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__TEXTS, null, msgs);
			msgs = basicSetTexts(newTexts, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__TEXTS, newTexts, newTexts));
	}
	...
	public NotificationChain basicSetReductionCards(ReductionCards newReductionCards, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__REDUCTION_CARDS, oldReductionCards, newReductionCards);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setReductionCards(ReductionCards newReductionCards) {
		if (newReductionCards != reductionCards) {
			...
			if (reductionCards != null)
				msgs = ((InternalEObject)reductionCards).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__REDUCTION_CARDS, null, msgs);
			if (newReductionCards != null)
				msgs = ((InternalEObject)newReductionCards).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__REDUCTION_CARDS, null, msgs);
			msgs = basicSetReductionCards(newReductionCards, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__REDUCTION_CARDS, newReductionCards, newReductionCards));
	}
	...
	public NotificationChain basicSetFareConstraintBundles(FareConstraintBundles newFareConstraintBundles, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__FARE_CONSTRAINT_BUNDLES, oldFareConstraintBundles, newFareConstraintBundles);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFareConstraintBundles(FareConstraintBundles newFareConstraintBundles) {
		if (newFareConstraintBundles != fareConstraintBundles) {
			...
			if (fareConstraintBundles != null)
				msgs = ((InternalEObject)fareConstraintBundles).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__FARE_CONSTRAINT_BUNDLES, null, msgs);
			if (newFareConstraintBundles != null)
				msgs = ((InternalEObject)newFareConstraintBundles).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__FARE_CONSTRAINT_BUNDLES, null, msgs);
			msgs = basicSetFareConstraintBundles(newFareConstraintBundles, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__FARE_CONSTRAINT_BUNDLES, newFareConstraintBundles, newFareConstraintBundles));
	}
	...
	public NotificationChain basicSetFareElements(FareElements newFareElements, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__FARE_ELEMENTS, oldFareElements, newFareElements);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFareElements(FareElements newFareElements) {
		if (newFareElements != fareElements) {
			...
			if (fareElements != null)
				msgs = ((InternalEObject)fareElements).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__FARE_ELEMENTS, null, msgs);
			if (newFareElements != null)
				msgs = ((InternalEObject)newFareElements).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__FARE_ELEMENTS, null, msgs);
			msgs = basicSetFareElements(newFareElements, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__FARE_ELEMENTS, newFareElements, newFareElements));
	}
	...
	public NotificationChain basicSetCombinationConstraints(CombinationConstraints newCombinationConstraints, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__COMBINATION_CONSTRAINTS, oldCombinationConstraints, newCombinationConstraints);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCombinationConstraints(CombinationConstraints newCombinationConstraints) {
		if (newCombinationConstraints != combinationConstraints) {
			...
			if (combinationConstraints != null)
				msgs = ((InternalEObject)combinationConstraints).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__COMBINATION_CONSTRAINTS, null, msgs);
			if (newCombinationConstraints != null)
				msgs = ((InternalEObject)newCombinationConstraints).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__COMBINATION_CONSTRAINTS, null, msgs);
			msgs = basicSetCombinationConstraints(newCombinationConstraints, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__COMBINATION_CONSTRAINTS, newCombinationConstraints, newCombinationConstraints));
	}
	...
	public NotificationChain basicSetSalesAvailabilityConstraints(SalesAvailabilityConstraints newSalesAvailabilityConstraints, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__SALES_AVAILABILITY_CONSTRAINTS, oldSalesAvailabilityConstraints, newSalesAvailabilityConstraints);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSalesAvailabilityConstraints(SalesAvailabilityConstraints newSalesAvailabilityConstraints) {
		if (newSalesAvailabilityConstraints != salesAvailabilityConstraints) {
			...
			if (salesAvailabilityConstraints != null)
				msgs = ((InternalEObject)salesAvailabilityConstraints).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__SALES_AVAILABILITY_CONSTRAINTS, null, msgs);
			if (newSalesAvailabilityConstraints != null)
				msgs = ((InternalEObject)newSalesAvailabilityConstraints).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__SALES_AVAILABILITY_CONSTRAINTS, null, msgs);
			msgs = basicSetSalesAvailabilityConstraints(newSalesAvailabilityConstraints, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__SALES_AVAILABILITY_CONSTRAINTS, newSalesAvailabilityConstraints, newSalesAvailabilityConstraints));
	}
	...
	public NotificationChain basicSetTravelValidityConstraints(TravelValidityConstraints newTravelValidityConstraints, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__TRAVEL_VALIDITY_CONSTRAINTS, oldTravelValidityConstraints, newTravelValidityConstraints);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTravelValidityConstraints(TravelValidityConstraints newTravelValidityConstraints) {
		if (newTravelValidityConstraints != travelValidityConstraints) {
			...
			if (travelValidityConstraints != null)
				msgs = ((InternalEObject)travelValidityConstraints).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__TRAVEL_VALIDITY_CONSTRAINTS, null, msgs);
			if (newTravelValidityConstraints != null)
				msgs = ((InternalEObject)newTravelValidityConstraints).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__TRAVEL_VALIDITY_CONSTRAINTS, null, msgs);
			msgs = basicSetTravelValidityConstraints(newTravelValidityConstraints, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__TRAVEL_VALIDITY_CONSTRAINTS, newTravelValidityConstraints, newTravelValidityConstraints));
	}
	...
	public NotificationChain basicSetRegionalConstraints(RegionalConstraints newRegionalConstraints, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__REGIONAL_CONSTRAINTS, oldRegionalConstraints, newRegionalConstraints);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRegionalConstraints(RegionalConstraints newRegionalConstraints) {
		if (newRegionalConstraints != regionalConstraints) {
			...
			if (regionalConstraints != null)
				msgs = ((InternalEObject)regionalConstraints).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__REGIONAL_CONSTRAINTS, null, msgs);
			if (newRegionalConstraints != null)
				msgs = ((InternalEObject)newRegionalConstraints).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__REGIONAL_CONSTRAINTS, null, msgs);
			msgs = basicSetRegionalConstraints(newRegionalConstraints, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__REGIONAL_CONSTRAINTS, newRegionalConstraints, newRegionalConstraints));
	}
	...
	public NotificationChain basicSetConnectionPoints(ConnectionPoints newConnectionPoints, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__CONNECTION_POINTS, oldConnectionPoints, newConnectionPoints);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setConnectionPoints(ConnectionPoints newConnectionPoints) {
		if (newConnectionPoints != connectionPoints) {
			...
			if (connectionPoints != null)
				msgs = ((InternalEObject)connectionPoints).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__CONNECTION_POINTS, null, msgs);
			if (newConnectionPoints != null)
				msgs = ((InternalEObject)newConnectionPoints).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__CONNECTION_POINTS, null, msgs);
			msgs = basicSetConnectionPoints(newConnectionPoints, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__CONNECTION_POINTS, newConnectionPoints, newConnectionPoints));
	}
	...
	public NotificationChain basicSetCarrierConstraints(CarrierConstraints newCarrierConstraints, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__CARRIER_CONSTRAINTS, oldCarrierConstraints, newCarrierConstraints);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCarrierConstraints(CarrierConstraints newCarrierConstraints) {
		if (newCarrierConstraints != carrierConstraints) {
			...
			if (carrierConstraints != null)
				msgs = ((InternalEObject)carrierConstraints).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__CARRIER_CONSTRAINTS, null, msgs);
			if (newCarrierConstraints != null)
				msgs = ((InternalEObject)newCarrierConstraints).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__CARRIER_CONSTRAINTS, null, msgs);
			msgs = basicSetCarrierConstraints(newCarrierConstraints, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__CARRIER_CONSTRAINTS, newCarrierConstraints, newCarrierConstraints));
	}
	...
	public NotificationChain basicSetServiceConstraints(ServiceConstraints newServiceConstraints, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__SERVICE_CONSTRAINTS, oldServiceConstraints, newServiceConstraints);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setServiceConstraints(ServiceConstraints newServiceConstraints) {
		if (newServiceConstraints != serviceConstraints) {
			...
			if (serviceConstraints != null)
				msgs = ((InternalEObject)serviceConstraints).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__SERVICE_CONSTRAINTS, null, msgs);
			if (newServiceConstraints != null)
				msgs = ((InternalEObject)newServiceConstraints).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__SERVICE_CONSTRAINTS, null, msgs);
			msgs = basicSetServiceConstraints(newServiceConstraints, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__SERVICE_CONSTRAINTS, newServiceConstraints, newServiceConstraints));
	}
	...
	public NotificationChain basicSetPassengerConstraints(PassengerConstraints newPassengerConstraints, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__PASSENGER_CONSTRAINTS, oldPassengerConstraints, newPassengerConstraints);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPassengerConstraints(PassengerConstraints newPassengerConstraints) {
		if (newPassengerConstraints != passengerConstraints) {
			...
			if (passengerConstraints != null)
				msgs = ((InternalEObject)passengerConstraints).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__PASSENGER_CONSTRAINTS, null, msgs);
			if (newPassengerConstraints != null)
				msgs = ((InternalEObject)newPassengerConstraints).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__PASSENGER_CONSTRAINTS, null, msgs);
			msgs = basicSetPassengerConstraints(newPassengerConstraints, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__PASSENGER_CONSTRAINTS, newPassengerConstraints, newPassengerConstraints));
	}
	...
	public NotificationChain basicSetTotalPassengerCombinationConstraints(TotalPassengerCombinationConstraints newTotalPassengerCombinationConstraints, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__TOTAL_PASSENGER_COMBINATION_CONSTRAINTS, oldTotalPassengerCombinationConstraints, newTotalPassengerCombinationConstraints);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTotalPassengerCombinationConstraints(TotalPassengerCombinationConstraints newTotalPassengerCombinationConstraints) {
		if (newTotalPassengerCombinationConstraints != totalPassengerCombinationConstraints) {
			...
			if (totalPassengerCombinationConstraints != null)
				msgs = ((InternalEObject)totalPassengerCombinationConstraints).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__TOTAL_PASSENGER_COMBINATION_CONSTRAINTS, null, msgs);
			if (newTotalPassengerCombinationConstraints != null)
				msgs = ((InternalEObject)newTotalPassengerCombinationConstraints).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__TOTAL_PASSENGER_COMBINATION_CONSTRAINTS, null, msgs);
			msgs = basicSetTotalPassengerCombinationConstraints(newTotalPassengerCombinationConstraints, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__TOTAL_PASSENGER_COMBINATION_CONSTRAINTS, newTotalPassengerCombinationConstraints, newTotalPassengerCombinationConstraints));
	}
	...
	public NotificationChain basicSetReductionConstraints(ReductionConstraints newReductionConstraints, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__REDUCTION_CONSTRAINTS, oldReductionConstraints, newReductionConstraints);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setReductionConstraints(ReductionConstraints newReductionConstraints) {
		if (newReductionConstraints != reductionConstraints) {
			...
			if (reductionConstraints != null)
				msgs = ((InternalEObject)reductionConstraints).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__REDUCTION_CONSTRAINTS, null, msgs);
			if (newReductionConstraints != null)
				msgs = ((InternalEObject)newReductionConstraints).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__REDUCTION_CONSTRAINTS, null, msgs);
			msgs = basicSetReductionConstraints(newReductionConstraints, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__REDUCTION_CONSTRAINTS, newReductionConstraints, newReductionConstraints));
	}
	...
	public NotificationChain basicSetPersonalDataConstraints(PersonalDataConstraints newPersonalDataConstraints, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__PERSONAL_DATA_CONSTRAINTS, oldPersonalDataConstraints, newPersonalDataConstraints);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPersonalDataConstraints(PersonalDataConstraints newPersonalDataConstraints) {
		if (newPersonalDataConstraints != personalDataConstraints) {
			...
			if (personalDataConstraints != null)
				msgs = ((InternalEObject)personalDataConstraints).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__PERSONAL_DATA_CONSTRAINTS, null, msgs);
			if (newPersonalDataConstraints != null)
				msgs = ((InternalEObject)newPersonalDataConstraints).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__PERSONAL_DATA_CONSTRAINTS, null, msgs);
			msgs = basicSetPersonalDataConstraints(newPersonalDataConstraints, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__PERSONAL_DATA_CONSTRAINTS, newPersonalDataConstraints, newPersonalDataConstraints));
	}
	...
	public NotificationChain basicSetAfterSalesRules(AfterSalesRules newAfterSalesRules, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__AFTER_SALES_RULES, oldAfterSalesRules, newAfterSalesRules);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAfterSalesRules(AfterSalesRules newAfterSalesRules) {
		if (newAfterSalesRules != afterSalesRules) {
			...
			if (afterSalesRules != null)
				msgs = ((InternalEObject)afterSalesRules).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__AFTER_SALES_RULES, null, msgs);
			if (newAfterSalesRules != null)
				msgs = ((InternalEObject)newAfterSalesRules).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__AFTER_SALES_RULES, null, msgs);
			msgs = basicSetAfterSalesRules(newAfterSalesRules, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__AFTER_SALES_RULES, newAfterSalesRules, newAfterSalesRules));
	}
	...
	public NotificationChain basicSetPrices(Prices newPrices, NotificationChain msgs) {
		...
		prices = newPrices;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__PRICES, oldPrices, newPrices);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPrices(Prices newPrices) {
		if (newPrices != prices) {
			NotificationChain msgs = null;
			if (prices != null)
				msgs = ((InternalEObject)prices).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__PRICES, null, msgs);
			if (newPrices != null)
				msgs = ((InternalEObject)newPrices).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__PRICES, null, msgs);
			msgs = basicSetPrices(newPrices, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__PRICES, newPrices, newPrices));
	}
	...
	public NotificationChain basicSetFulfillmentConstraints(FulfillmentConstraints newFulfillmentConstraints, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__FULFILLMENT_CONSTRAINTS, oldFulfillmentConstraints, newFulfillmentConstraints);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFulfillmentConstraints(FulfillmentConstraints newFulfillmentConstraints) {
		if (newFulfillmentConstraints != fulfillmentConstraints) {
			...
			if (fulfillmentConstraints != null)
				msgs = ((InternalEObject)fulfillmentConstraints).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__FULFILLMENT_CONSTRAINTS, null, msgs);
			if (newFulfillmentConstraints != null)
				msgs = ((InternalEObject)newFulfillmentConstraints).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__FULFILLMENT_CONSTRAINTS, null, msgs);
			msgs = basicSetFulfillmentConstraints(newFulfillmentConstraints, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__FULFILLMENT_CONSTRAINTS, newFulfillmentConstraints, newFulfillmentConstraints));
	}
	...
	public NotificationChain basicSetReservationParameters(ReservationParameters newReservationParameters, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__RESERVATION_PARAMETERS, oldReservationParameters, newReservationParameters);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setReservationParameters(ReservationParameters newReservationParameters) {
		if (newReservationParameters != reservationParameters) {
			...
			if (reservationParameters != null)
				msgs = ((InternalEObject)reservationParameters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__RESERVATION_PARAMETERS, null, msgs);
			if (newReservationParameters != null)
				msgs = ((InternalEObject)newReservationParameters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__RESERVATION_PARAMETERS, null, msgs);
			msgs = basicSetReservationParameters(newReservationParameters, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__RESERVATION_PARAMETERS, newReservationParameters, newReservationParameters));
	}
	...
	public NotificationChain basicSetSupportedOnlineServices(SupportedOnlineServices newSupportedOnlineServices, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__SUPPORTED_ONLINE_SERVICES, oldSupportedOnlineServices, newSupportedOnlineServices);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSupportedOnlineServices(SupportedOnlineServices newSupportedOnlineServices) {
		if (newSupportedOnlineServices != supportedOnlineServices) {
			...
			if (supportedOnlineServices != null)
				msgs = ((InternalEObject)supportedOnlineServices).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__SUPPORTED_ONLINE_SERVICES, null, msgs);
			if (newSupportedOnlineServices != null)
				msgs = ((InternalEObject)newSupportedOnlineServices).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__SUPPORTED_ONLINE_SERVICES, null, msgs);
			msgs = basicSetSupportedOnlineServices(newSupportedOnlineServices, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__SUPPORTED_ONLINE_SERVICES, newSupportedOnlineServices, newSupportedOnlineServices));
	}
	...
	public NotificationChain basicSetFareResourceLocations(FareResourceLocations newFareResourceLocations, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__FARE_RESOURCE_LOCATIONS, oldFareResourceLocations, newFareResourceLocations);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFareResourceLocations(FareResourceLocations newFareResourceLocations) {
		if (newFareResourceLocations != fareResourceLocations) {
			...
			if (fareResourceLocations != null)
				msgs = ((InternalEObject)fareResourceLocations).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__FARE_RESOURCE_LOCATIONS, null, msgs);
			if (newFareResourceLocations != null)
				msgs = ((InternalEObject)newFareResourceLocations).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__FARE_RESOURCE_LOCATIONS, null, msgs);
			msgs = basicSetFareResourceLocations(newFareResourceLocations, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__FARE_RESOURCE_LOCATIONS, newFareResourceLocations, newFareResourceLocations));
	}
	...
	public NotificationChain basicSetZoneDefinitions(ZoneDefinitions newZoneDefinitions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__ZONE_DEFINITIONS, oldZoneDefinitions, newZoneDefinitions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setZoneDefinitions(ZoneDefinitions newZoneDefinitions) {
		if (newZoneDefinitions != zoneDefinitions) {
			...
			if (zoneDefinitions != null)
				msgs = ((InternalEObject)zoneDefinitions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__ZONE_DEFINITIONS, null, msgs);
			if (newZoneDefinitions != null)
				msgs = ((InternalEObject)newZoneDefinitions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__ZONE_DEFINITIONS, null, msgs);
			msgs = basicSetZoneDefinitions(newZoneDefinitions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__ZONE_DEFINITIONS, newZoneDefinitions, newZoneDefinitions));
	}
	...
	public NotificationChain basicSetLuggageConstraints(LuggageConstraints newLuggageConstraints, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__LUGGAGE_CONSTRAINTS, oldLuggageConstraints, newLuggageConstraints);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLuggageConstraints(LuggageConstraints newLuggageConstraints) {
		if (newLuggageConstraints != luggageConstraints) {
			...
			if (luggageConstraints != null)
				msgs = ((InternalEObject)luggageConstraints).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__LUGGAGE_CONSTRAINTS, null, msgs);
			if (newLuggageConstraints != null)
				msgs = ((InternalEObject)newLuggageConstraints).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_STRUCTURE__LUGGAGE_CONSTRAINTS, null, msgs);
			msgs = basicSetLuggageConstraints(newLuggageConstraints, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STRUCTURE__LUGGAGE_CONSTRAINTS, newLuggageConstraints, newLuggageConstraints));
	}
