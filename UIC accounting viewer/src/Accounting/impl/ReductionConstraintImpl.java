 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.ReductionConstraintImpl#getId <em>Id</em>}</li>
 *   <li>{@link Accounting.impl.ReductionConstraintImpl#getRequiredReductionCards <em>Required Reduction Cards</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReductionConstraintImpl extends MinimalEObjectImpl.Container implements ReductionConstraint {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.REDUCTION_CONSTRAINT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.REDUCTION_CONSTRAINT__ID, oldId, id));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AccountingPackage.REDUCTION_CONSTRAINT__REQUIRED_REDUCTION_CARDS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.REDUCTION_CONSTRAINT__ID:
				return getId();
			case AccountingPackage.REDUCTION_CONSTRAINT__REQUIRED_REDUCTION_CARDS:
