 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.ServiceConstraintImpl#getId <em>Id</em>}</li>
 *   <li>{@link Accounting.impl.ServiceConstraintImpl#getIncludedServiceBrands <em>Included Service Brands</em>}</li>
 *   <li>{@link Accounting.impl.ServiceConstraintImpl#getExcludedServiceBrands <em>Excluded Service Brands</em>}</li>
 *   <li>{@link Accounting.impl.ServiceConstraintImpl#getDataDescription <em>Data Description</em>}</li>
 *   <li>{@link Accounting.impl.ServiceConstraintImpl#getLegacy108Code <em>Legacy108 Code</em>}</li>
 *   <li>{@link Accounting.impl.ServiceConstraintImpl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ServiceConstraintImpl extends MinimalEObjectImpl.Container implements ServiceConstraint {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.SERVICE_CONSTRAINT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.SERVICE_CONSTRAINT__ID, oldId, id));
	}
	...
	public void setDataDescription(String newDataDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.SERVICE_CONSTRAINT__DATA_DESCRIPTION, oldDataDescription, dataDescription));
	}
	...
	public void setLegacy108Code(int newLegacy108Code) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.SERVICE_CONSTRAINT__LEGACY108_CODE, oldLegacy108Code, legacy108Code));
	}
	...
	public Text getDescription() {
		if (description != null && description.eIsProxy()) {
			...
			if (description != oldDescription) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.SERVICE_CONSTRAINT__DESCRIPTION, oldDescription, description));
			}
		}
		return description;
	}
	...
	public void setDescription(Text newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.SERVICE_CONSTRAINT__DESCRIPTION, oldDescription, description));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.SERVICE_CONSTRAINT__ID:
				return getId();
			case AccountingPackage.SERVICE_CONSTRAINT__INCLUDED_SERVICE_BRANDS:
				return getIncludedServiceBrands();
			case AccountingPackage.SERVICE_CONSTRAINT__EXCLUDED_SERVICE_BRANDS:
				return getExcludedServiceBrands();
			case AccountingPackage.SERVICE_CONSTRAINT__DATA_DESCRIPTION:
				return getDataDescription();
			case AccountingPackage.SERVICE_CONSTRAINT__LEGACY108_CODE:
				return getLegacy108Code();
			case AccountingPackage.SERVICE_CONSTRAINT__DESCRIPTION:
