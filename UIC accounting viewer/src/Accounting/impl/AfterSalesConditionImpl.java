...
import Accounting.AfterSalesCondition;
import Accounting.AfterSalesTransactionType;
import Accounting.ApplicationTime;
 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.AfterSalesConditionImpl#getTransactionType <em>Transaction Type</em>}</li>
 *   <li>{@link Accounting.impl.AfterSalesConditionImpl#isIndividualContracts <em>Individual Contracts</em>}</li>
 *   <li>{@link Accounting.impl.AfterSalesConditionImpl#isCarrierFee <em>Carrier Fee</em>}</li>
 *   <li>{@link Accounting.impl.AfterSalesConditionImpl#getFee <em>Fee</em>}</li>
 *   <li>{@link Accounting.impl.AfterSalesConditionImpl#getApplicationTime <em>Application Time</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AfterSalesConditionImpl extends MinimalEObjectImpl.Container implements AfterSalesCondition {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.AFTER_SALES_CONDITION;
	}
	...
	public void setTransactionType(AfterSalesTransactionType newTransactionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.AFTER_SALES_CONDITION__TRANSACTION_TYPE, oldTransactionType, transactionType));
	}
	...
	public void setIndividualContracts(boolean newIndividualContracts) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.AFTER_SALES_CONDITION__INDIVIDUAL_CONTRACTS, oldIndividualContracts, individualContracts));
	}
	...
	public void setCarrierFee(boolean newCarrierFee) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.AFTER_SALES_CONDITION__CARRIER_FEE, oldCarrierFee, carrierFee));
	}
	...
	public Price getFee() {
		if (fee != null && fee.eIsProxy()) {
			...
			if (fee != oldFee) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.AFTER_SALES_CONDITION__FEE, oldFee, fee));
			}
		}
		return fee;
	}
	...
	public void setFee(Price newFee) {
		...
		fee = newFee;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.AFTER_SALES_CONDITION__FEE, oldFee, fee));
	}
	...
	public NotificationChain basicSetApplicationTime(ApplicationTime newApplicationTime, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.AFTER_SALES_CONDITION__APPLICATION_TIME, oldApplicationTime, newApplicationTime);
	...
	public void setApplicationTime(ApplicationTime newApplicationTime) {
		if (newApplicationTime != applicationTime) {
			...
			if (applicationTime != null)
				msgs = ((InternalEObject)applicationTime).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.AFTER_SALES_CONDITION__APPLICATION_TIME, null, msgs);
			if (newApplicationTime != null)
				msgs = ((InternalEObject)newApplicationTime).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.AFTER_SALES_CONDITION__APPLICATION_TIME, null, msgs);
			msgs = basicSetApplicationTime(newApplicationTime, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.AFTER_SALES_CONDITION__APPLICATION_TIME, newApplicationTime, newApplicationTime));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AccountingPackage.AFTER_SALES_CONDITION__APPLICATION_TIME:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.AFTER_SALES_CONDITION__TRANSACTION_TYPE:
				return getTransactionType();
			case AccountingPackage.AFTER_SALES_CONDITION__INDIVIDUAL_CONTRACTS:
				return isIndividualContracts();
			case AccountingPackage.AFTER_SALES_CONDITION__CARRIER_FEE:
				return isCarrierFee();
			case AccountingPackage.AFTER_SALES_CONDITION__FEE:
