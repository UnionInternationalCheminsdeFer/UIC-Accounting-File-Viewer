...
import Accounting.AddCarrierRule;
import Accounting.AddCarrierScope;
 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.AddCarrierRuleImpl#getCarrier <em>Carrier</em>}</li>
 *   <li>{@link Accounting.impl.AddCarrierRuleImpl#getScope <em>Scope</em>}</li>
 *   <li>{@link Accounting.impl.AddCarrierRuleImpl#getStations <em>Stations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AddCarrierRuleImpl extends MinimalEObjectImpl.Container implements AddCarrierRule {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.ADD_CARRIER_RULE;
	}
		...
		if (carrier != null && carrier.eIsProxy()) {
			...
			if (carrier != oldCarrier) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.ADD_CARRIER_RULE__CARRIER, oldCarrier, carrier));
			}
		}
		return carrier;
	}
	...
	public void setCarrier(Carrier newCarrier) {
		...
		carrier = newCarrier;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.ADD_CARRIER_RULE__CARRIER, oldCarrier, carrier));
	}
	...
	public void setScope(AddCarrierScope newScope) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.ADD_CARRIER_RULE__SCOPE, oldScope, scope));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.ADD_CARRIER_RULE__CARRIER:
				if (resolve) return getCarrier();
				return basicGetCarrier();
			case AccountingPackage.ADD_CARRIER_RULE__SCOPE:
				return getScope();
			case AccountingPackage.ADD_CARRIER_RULE__STATIONS:
				return getStations();
		}
