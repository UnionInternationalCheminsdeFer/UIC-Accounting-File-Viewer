...
import Accounting.LuggageItemsRestriction;
import Accounting.LuggageRule;
 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.LuggageConstraintImpl#getId <em>Id</em>}</li>
 *   <li>{@link Accounting.impl.LuggageConstraintImpl#getMaxHandLuggage <em>Max Hand Luggage</em>}</li>
 *   <li>{@link Accounting.impl.LuggageConstraintImpl#getMaxLargeLuggage <em>Max Large Luggage</em>}</li>
 *   <li>{@link Accounting.impl.LuggageConstraintImpl#getRestrictedItems <em>Restricted Items</em>}</li>
 *   <li>{@link Accounting.impl.LuggageConstraintImpl#getRules <em>Rules</em>}</li>
 *   <li>{@link Accounting.impl.LuggageConstraintImpl#getDataDescription <em>Data Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LuggageConstraintImpl extends MinimalEObjectImpl.Container implements LuggageConstraint {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.LUGGAGE_CONSTRAINT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.LUGGAGE_CONSTRAINT__ID, oldId, id));
	}
	...
	public void setMaxHandLuggage(int newMaxHandLuggage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.LUGGAGE_CONSTRAINT__MAX_HAND_LUGGAGE, oldMaxHandLuggage, maxHandLuggage));
	}
	...
	public void setMaxLargeLuggage(int newMaxLargeLuggage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.LUGGAGE_CONSTRAINT__MAX_LARGE_LUGGAGE, oldMaxLargeLuggage, maxLargeLuggage));
	}
	...
	public void setDataDescription(String newDataDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.LUGGAGE_CONSTRAINT__DATA_DESCRIPTION, oldDataDescription, dataDescription));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AccountingPackage.LUGGAGE_CONSTRAINT__RESTRICTED_ITEMS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.LUGGAGE_CONSTRAINT__ID:
				return getId();
			case AccountingPackage.LUGGAGE_CONSTRAINT__MAX_HAND_LUGGAGE:
				return getMaxHandLuggage();
			case AccountingPackage.LUGGAGE_CONSTRAINT__MAX_LARGE_LUGGAGE:
				return getMaxLargeLuggage();
			case AccountingPackage.LUGGAGE_CONSTRAINT__RESTRICTED_ITEMS:
				return getRestrictedItems();
			case AccountingPackage.LUGGAGE_CONSTRAINT__RULES:
				return getRules();
			case AccountingPackage.LUGGAGE_CONSTRAINT__DATA_DESCRIPTION:
