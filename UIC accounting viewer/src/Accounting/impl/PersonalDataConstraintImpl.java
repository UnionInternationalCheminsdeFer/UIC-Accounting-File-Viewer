 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.PersonalDataConstraintImpl#getId <em>Id</em>}</li>
 *   <li>{@link Accounting.impl.PersonalDataConstraintImpl#getRequiredPersonalData <em>Required Personal Data</em>}</li>
 *   <li>{@link Accounting.impl.PersonalDataConstraintImpl#getAllowedChanges <em>Allowed Changes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PersonalDataConstraintImpl extends MinimalEObjectImpl.Container implements PersonalDataConstraint {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.PERSONAL_DATA_CONSTRAINT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.PERSONAL_DATA_CONSTRAINT__ID, oldId, id));
	}
