...
import Accounting.StationRelationType;
 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.StationRelationImpl#getRelationType <em>Relation Type</em>}</li>
 *   <li>{@link Accounting.impl.StationRelationImpl#getStation <em>Station</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StationRelationImpl extends MinimalEObjectImpl.Container implements StationRelation {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.STATION_RELATION;
	}
	...
	public void setRelationType(StationRelationType newRelationType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.STATION_RELATION__RELATION_TYPE, oldRelationType, relationType));
	}
	...
	public Station getStation() {
		if (station != null && station.eIsProxy()) {
			...
			if (station != oldStation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.STATION_RELATION__STATION, oldStation, station));
			}
		}
		return station;
	}
	...
	public void setStation(Station newStation) {
		...
		station = newStation;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.STATION_RELATION__STATION, oldStation, station));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.STATION_RELATION__RELATION_TYPE:
				return getRelationType();
			case AccountingPackage.STATION_RELATION__STATION:
