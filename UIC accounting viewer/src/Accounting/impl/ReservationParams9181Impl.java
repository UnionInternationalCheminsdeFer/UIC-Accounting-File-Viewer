...
import Accounting.ReservationBerthType;
import Accounting.ReservationParams9181;
import Accounting.ReservationService;
import Accounting.ReservationServiceLevel;
import Accounting.ReservationTravelClass;
 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.ReservationParams9181Impl#getTravelClass <em>Travel Class</em>}</li>
 *   <li>{@link Accounting.impl.ReservationParams9181Impl#getServiceLevel <em>Service Level</em>}</li>
 *   <li>{@link Accounting.impl.ReservationParams9181Impl#getService <em>Service</em>}</li>
 *   <li>{@link Accounting.impl.ReservationParams9181Impl#getBerthType <em>Berth Type</em>}</li>
 *   <li>{@link Accounting.impl.ReservationParams9181Impl#getCoachType <em>Coach Type</em>}</li>
 *   <li>{@link Accounting.impl.ReservationParams9181Impl#getCompartmentType <em>Compartment Type</em>}</li>
 *   <li>{@link Accounting.impl.ReservationParams9181Impl#getTariff <em>Tariff</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReservationParams9181Impl extends MinimalEObjectImpl.Container implements ReservationParams9181 {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.RESERVATION_PARAMS9181;
	}
	...
	public void setTravelClass(ReservationTravelClass newTravelClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.RESERVATION_PARAMS9181__TRAVEL_CLASS, oldTravelClass, travelClass));
	}
	...
	public void setServiceLevel(ReservationServiceLevel newServiceLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.RESERVATION_PARAMS9181__SERVICE_LEVEL, oldServiceLevel, serviceLevel));
	}
	...
	public void setService(ReservationService newService) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.RESERVATION_PARAMS9181__SERVICE, oldService, service));
	}
	...
	public void setBerthType(ReservationBerthType newBerthType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.RESERVATION_PARAMS9181__BERTH_TYPE, oldBerthType, berthType));
	}
	...
	public void setCoachType(int newCoachType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.RESERVATION_PARAMS9181__COACH_TYPE, oldCoachType, coachType));
	}
	...
	public void setCompartmentType(int newCompartmentType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.RESERVATION_PARAMS9181__COMPARTMENT_TYPE, oldCompartmentType, compartmentType));
	}
	...
	public void setTariff(int newTariff) {
		...
		tariff = newTariff;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.RESERVATION_PARAMS9181__TARIFF, oldTariff, tariff));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.RESERVATION_PARAMS9181__TRAVEL_CLASS:
				return getTravelClass();
			case AccountingPackage.RESERVATION_PARAMS9181__SERVICE_LEVEL:
				return getServiceLevel();
			case AccountingPackage.RESERVATION_PARAMS9181__SERVICE:
				return getService();
			case AccountingPackage.RESERVATION_PARAMS9181__BERTH_TYPE:
				return getBerthType();
			case AccountingPackage.RESERVATION_PARAMS9181__COACH_TYPE:
				return getCoachType();
			case AccountingPackage.RESERVATION_PARAMS9181__COMPARTMENT_TYPE:
				return getCompartmentType();
			case AccountingPackage.RESERVATION_PARAMS9181__TARIFF:
				return getTariff();
		}
