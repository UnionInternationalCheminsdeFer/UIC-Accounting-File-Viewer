...
import Accounting.CombinationConstraint;
import Accounting.DataSource;
import Accounting.FareConstraintBundle;
import Accounting.FareElement;
import Accounting.FareType;
import Accounting.FulfillmentConstraint;
import Accounting.LegacyAccountingIdentifier;
import Accounting.LegacyConversionType;
import Accounting.LuggageConstraint;
import Accounting.PassengerConstraint;
import Accounting.PersonalDataConstraint;
import Accounting.Price;
import Accounting.ReductionConstraint;
import Accounting.RegionalConstraint;
import Accounting.RegulatoryCondition;
import Accounting.ReservationParameter;
import Accounting.SalesAvailabilityConstraint;
import Accounting.ServiceClass;
import Accounting.ServiceConstraint;
import Accounting.ServiceLevel;
 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.FareElementImpl#getId <em>Id</em>}</li>
 *   <li>{@link Accounting.impl.FareElementImpl#getType <em>Type</em>}</li>
 *   <li>{@link Accounting.impl.FareElementImpl#getDataDescription <em>Data Description</em>}</li>
 *   <li>{@link Accounting.impl.FareElementImpl#getFareConstraintBundle <em>Fare Constraint Bundle</em>}</li>
 *   <li>{@link Accounting.impl.FareElementImpl#getText <em>Text</em>}</li>
 *   <li>{@link Accounting.impl.FareElementImpl#getPrice <em>Price</em>}</li>
 *   <li>{@link Accounting.impl.FareElementImpl#getRegionalConstraint <em>Regional Constraint</em>}</li>
 *   <li>{@link Accounting.impl.FareElementImpl#getServiceConstraint <em>Service Constraint</em>}</li>
 *   <li>{@link Accounting.impl.FareElementImpl#getCarrierConstraint <em>Carrier Constraint</em>}</li>
 *   <li>{@link Accounting.impl.FareElementImpl#getServiceClass <em>Service Class</em>}</li>
 *   <li>{@link Accounting.impl.FareElementImpl#getServiceLevel <em>Service Level</em>}</li>
 *   <li>{@link Accounting.impl.FareElementImpl#getSalesAvailability <em>Sales Availability</em>}</li>
 *   <li>{@link Accounting.impl.FareElementImpl#getTravelValidity <em>Travel Validity</em>}</li>
 *   <li>{@link Accounting.impl.FareElementImpl#getCombinationConstraint <em>Combination Constraint</em>}</li>
 *   <li>{@link Accounting.impl.FareElementImpl#getFareDetailDescription <em>Fare Detail Description</em>}</li>
 *   <li>{@link Accounting.impl.FareElementImpl#getPersonalDataConstraint <em>Personal Data Constraint</em>}</li>
 *   <li>{@link Accounting.impl.FareElementImpl#getReservationParameter <em>Reservation Parameter</em>}</li>
 *   <li>{@link Accounting.impl.FareElementImpl#getReductionConstraint <em>Reduction Constraint</em>}</li>
 *   <li>{@link Accounting.impl.FareElementImpl#getFulfillmentConstraint <em>Fulfillment Constraint</em>}</li>
 *   <li>{@link Accounting.impl.FareElementImpl#getPassengerConstraint <em>Passenger Constraint</em>}</li>
 *   <li>{@link Accounting.impl.FareElementImpl#getRegulatoryConditions <em>Regulatory Conditions</em>}</li>
 *   <li>{@link Accounting.impl.FareElementImpl#getAfterSalesRule <em>After Sales Rule</em>}</li>
 *   <li>{@link Accounting.impl.FareElementImpl#getDataSource <em>Data Source</em>}</li>
 *   <li>{@link Accounting.impl.FareElementImpl#getLegacyAccountingIdentifier <em>Legacy Accounting Identifier</em>}</li>
 *   <li>{@link Accounting.impl.FareElementImpl#getLegacyConversion <em>Legacy Conversion</em>}</li>
 *   <li>{@link Accounting.impl.FareElementImpl#isIndividualContracts <em>Individual Contracts</em>}</li>
 *   <li>{@link Accounting.impl.FareElementImpl#getInvolvedTcos <em>Involved Tcos</em>}</li>
 *   <li>{@link Accounting.impl.FareElementImpl#getLuggageConstraint <em>Luggage Constraint</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FareElementImpl extends MinimalEObjectImpl.Container implements FareElement {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.FARE_ELEMENT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_ELEMENT__ID, oldId, id));
	}
	...
	public void setType(FareType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_ELEMENT__TYPE, oldType, type));
	}
	...
	public void setDataDescription(String newDataDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_ELEMENT__DATA_DESCRIPTION, oldDataDescription, dataDescription));
	}
	...
	public FareConstraintBundle getFareConstraintBundle() {
		if (fareConstraintBundle != null && fareConstraintBundle.eIsProxy()) {
			...
			if (fareConstraintBundle != oldFareConstraintBundle) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.FARE_ELEMENT__FARE_CONSTRAINT_BUNDLE, oldFareConstraintBundle, fareConstraintBundle));
			}
		}
	...
	public void setFareConstraintBundle(FareConstraintBundle newFareConstraintBundle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_ELEMENT__FARE_CONSTRAINT_BUNDLE, oldFareConstraintBundle, fareConstraintBundle));
	}
	...
	public Text getText() {
		if (text != null && text.eIsProxy()) {
			...
			if (text != oldText) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.FARE_ELEMENT__TEXT, oldText, text));
			}
		}
		return text;
	}
	...
	public void setText(Text newText) {
		...
		text = newText;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_ELEMENT__TEXT, oldText, text));
	}
	...
	public Price getPrice() {
		if (price != null && price.eIsProxy()) {
			...
			if (price != oldPrice) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.FARE_ELEMENT__PRICE, oldPrice, price));
			}
		}
		return price;
	}
	...
	public void setPrice(Price newPrice) {
		...
		price = newPrice;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_ELEMENT__PRICE, oldPrice, price));
	}
	...
	public RegionalConstraint getRegionalConstraint() {
		if (regionalConstraint != null && regionalConstraint.eIsProxy()) {
			...
			if (regionalConstraint != oldRegionalConstraint) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.FARE_ELEMENT__REGIONAL_CONSTRAINT, oldRegionalConstraint, regionalConstraint));
			}
		}
	...
	public void setRegionalConstraint(RegionalConstraint newRegionalConstraint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_ELEMENT__REGIONAL_CONSTRAINT, oldRegionalConstraint, regionalConstraint));
	}
	...
	public ServiceConstraint getServiceConstraint() {
		if (serviceConstraint != null && serviceConstraint.eIsProxy()) {
			...
			if (serviceConstraint != oldServiceConstraint) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.FARE_ELEMENT__SERVICE_CONSTRAINT, oldServiceConstraint, serviceConstraint));
			}
		}
	...
	public void setServiceConstraint(ServiceConstraint newServiceConstraint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_ELEMENT__SERVICE_CONSTRAINT, oldServiceConstraint, serviceConstraint));
	}
	...
	public CarrierConstraint getCarrierConstraint() {
		if (carrierConstraint != null && carrierConstraint.eIsProxy()) {
			...
			if (carrierConstraint != oldCarrierConstraint) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.FARE_ELEMENT__CARRIER_CONSTRAINT, oldCarrierConstraint, carrierConstraint));
			}
		}
	...
	public void setCarrierConstraint(CarrierConstraint newCarrierConstraint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_ELEMENT__CARRIER_CONSTRAINT, oldCarrierConstraint, carrierConstraint));
	}
	...
	public ServiceClass getServiceClass() {
		if (serviceClass != null && serviceClass.eIsProxy()) {
			...
			if (serviceClass != oldServiceClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.FARE_ELEMENT__SERVICE_CLASS, oldServiceClass, serviceClass));
			}
		}
		return serviceClass;
	}
	...
	public void setServiceClass(ServiceClass newServiceClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_ELEMENT__SERVICE_CLASS, oldServiceClass, serviceClass));
	}
	...
	public ServiceLevel getServiceLevel() {
		if (serviceLevel != null && serviceLevel.eIsProxy()) {
			...
			if (serviceLevel != oldServiceLevel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.FARE_ELEMENT__SERVICE_LEVEL, oldServiceLevel, serviceLevel));
			}
		}
		return serviceLevel;
	}
	...
	public void setServiceLevel(ServiceLevel newServiceLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_ELEMENT__SERVICE_LEVEL, oldServiceLevel, serviceLevel));
	}
	...
	public SalesAvailabilityConstraint getSalesAvailability() {
		if (salesAvailability != null && salesAvailability.eIsProxy()) {
			...
			if (salesAvailability != oldSalesAvailability) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.FARE_ELEMENT__SALES_AVAILABILITY, oldSalesAvailability, salesAvailability));
			}
		}
	...
	public void setSalesAvailability(SalesAvailabilityConstraint newSalesAvailability) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_ELEMENT__SALES_AVAILABILITY, oldSalesAvailability, salesAvailability));
	}
	...
	public TravelValidityConstraint getTravelValidity() {
		if (travelValidity != null && travelValidity.eIsProxy()) {
			...
			if (travelValidity != oldTravelValidity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.FARE_ELEMENT__TRAVEL_VALIDITY, oldTravelValidity, travelValidity));
			}
		}
	...
	public void setTravelValidity(TravelValidityConstraint newTravelValidity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_ELEMENT__TRAVEL_VALIDITY, oldTravelValidity, travelValidity));
	}
	...
	public CombinationConstraint getCombinationConstraint() {
		if (combinationConstraint != null && combinationConstraint.eIsProxy()) {
			...
			if (combinationConstraint != oldCombinationConstraint) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.FARE_ELEMENT__COMBINATION_CONSTRAINT, oldCombinationConstraint, combinationConstraint));
			}
		}
	...
	public void setCombinationConstraint(CombinationConstraint newCombinationConstraint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_ELEMENT__COMBINATION_CONSTRAINT, oldCombinationConstraint, combinationConstraint));
	}
	...
	public Text getFareDetailDescription() {
		if (fareDetailDescription != null && fareDetailDescription.eIsProxy()) {
			...
			if (fareDetailDescription != oldFareDetailDescription) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.FARE_ELEMENT__FARE_DETAIL_DESCRIPTION, oldFareDetailDescription, fareDetailDescription));
			}
		}
	...
	public void setFareDetailDescription(Text newFareDetailDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_ELEMENT__FARE_DETAIL_DESCRIPTION, oldFareDetailDescription, fareDetailDescription));
	}
	...
	public PersonalDataConstraint getPersonalDataConstraint() {
		if (personalDataConstraint != null && personalDataConstraint.eIsProxy()) {
			...
			if (personalDataConstraint != oldPersonalDataConstraint) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.FARE_ELEMENT__PERSONAL_DATA_CONSTRAINT, oldPersonalDataConstraint, personalDataConstraint));
			}
		}
	...
	public void setPersonalDataConstraint(PersonalDataConstraint newPersonalDataConstraint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_ELEMENT__PERSONAL_DATA_CONSTRAINT, oldPersonalDataConstraint, personalDataConstraint));
	}
	...
	public ReservationParameter getReservationParameter() {
		if (reservationParameter != null && reservationParameter.eIsProxy()) {
			...
			if (reservationParameter != oldReservationParameter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.FARE_ELEMENT__RESERVATION_PARAMETER, oldReservationParameter, reservationParameter));
			}
		}
	...
	public void setReservationParameter(ReservationParameter newReservationParameter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_ELEMENT__RESERVATION_PARAMETER, oldReservationParameter, reservationParameter));
	}
	...
	public ReductionConstraint getReductionConstraint() {
		if (reductionConstraint != null && reductionConstraint.eIsProxy()) {
			...
			if (reductionConstraint != oldReductionConstraint) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.FARE_ELEMENT__REDUCTION_CONSTRAINT, oldReductionConstraint, reductionConstraint));
			}
		}
	...
	public void setReductionConstraint(ReductionConstraint newReductionConstraint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_ELEMENT__REDUCTION_CONSTRAINT, oldReductionConstraint, reductionConstraint));
	}
	...
	public FulfillmentConstraint getFulfillmentConstraint() {
		if (fulfillmentConstraint != null && fulfillmentConstraint.eIsProxy()) {
			...
			if (fulfillmentConstraint != oldFulfillmentConstraint) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.FARE_ELEMENT__FULFILLMENT_CONSTRAINT, oldFulfillmentConstraint, fulfillmentConstraint));
			}
		}
	...
	public void setFulfillmentConstraint(FulfillmentConstraint newFulfillmentConstraint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_ELEMENT__FULFILLMENT_CONSTRAINT, oldFulfillmentConstraint, fulfillmentConstraint));
	}
	...
	public PassengerConstraint getPassengerConstraint() {
		if (passengerConstraint != null && passengerConstraint.eIsProxy()) {
			...
			if (passengerConstraint != oldPassengerConstraint) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.FARE_ELEMENT__PASSENGER_CONSTRAINT, oldPassengerConstraint, passengerConstraint));
			}
		}
	...
	public void setPassengerConstraint(PassengerConstraint newPassengerConstraint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_ELEMENT__PASSENGER_CONSTRAINT, oldPassengerConstraint, passengerConstraint));
	}
	...
	public AfterSalesRule getAfterSalesRule() {
		if (afterSalesRule != null && afterSalesRule.eIsProxy()) {
			...
			if (afterSalesRule != oldAfterSalesRule) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.FARE_ELEMENT__AFTER_SALES_RULE, oldAfterSalesRule, afterSalesRule));
			}
		}
	...
	public void setAfterSalesRule(AfterSalesRule newAfterSalesRule) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_ELEMENT__AFTER_SALES_RULE, oldAfterSalesRule, afterSalesRule));
	}
	...
	public void setDataSource(DataSource newDataSource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_ELEMENT__DATA_SOURCE, oldDataSource, dataSource));
	}
	...
	public NotificationChain basicSetLegacyAccountingIdentifier(LegacyAccountingIdentifier newLegacyAccountingIdentifier, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_ELEMENT__LEGACY_ACCOUNTING_IDENTIFIER, oldLegacyAccountingIdentifier, newLegacyAccountingIdentifier);
	...
	public void setLegacyAccountingIdentifier(LegacyAccountingIdentifier newLegacyAccountingIdentifier) {
		if (newLegacyAccountingIdentifier != legacyAccountingIdentifier) {
			...
			if (legacyAccountingIdentifier != null)
				msgs = ((InternalEObject)legacyAccountingIdentifier).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_ELEMENT__LEGACY_ACCOUNTING_IDENTIFIER, null, msgs);
			if (newLegacyAccountingIdentifier != null)
				msgs = ((InternalEObject)newLegacyAccountingIdentifier).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_ELEMENT__LEGACY_ACCOUNTING_IDENTIFIER, null, msgs);
			msgs = basicSetLegacyAccountingIdentifier(newLegacyAccountingIdentifier, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_ELEMENT__LEGACY_ACCOUNTING_IDENTIFIER, newLegacyAccountingIdentifier, newLegacyAccountingIdentifier));
	}
	...
	public void setLegacyConversion(LegacyConversionType newLegacyConversion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_ELEMENT__LEGACY_CONVERSION, oldLegacyConversion, legacyConversion));
	}
	...
	public void setIndividualContracts(boolean newIndividualContracts) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_ELEMENT__INDIVIDUAL_CONTRACTS, oldIndividualContracts, individualContracts));
	}
	...
	public LuggageConstraint getLuggageConstraint() {
		if (luggageConstraint != null && luggageConstraint.eIsProxy()) {
			...
			if (luggageConstraint != oldLuggageConstraint) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.FARE_ELEMENT__LUGGAGE_CONSTRAINT, oldLuggageConstraint, luggageConstraint));
			}
		}
	...
	public void setLuggageConstraint(LuggageConstraint newLuggageConstraint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_ELEMENT__LUGGAGE_CONSTRAINT, oldLuggageConstraint, luggageConstraint));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AccountingPackage.FARE_ELEMENT__LEGACY_ACCOUNTING_IDENTIFIER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.FARE_ELEMENT__ID:
				return getId();
			case AccountingPackage.FARE_ELEMENT__TYPE:
				return getType();
			case AccountingPackage.FARE_ELEMENT__DATA_DESCRIPTION:
				return getDataDescription();
			case AccountingPackage.FARE_ELEMENT__FARE_CONSTRAINT_BUNDLE:
				if (resolve) return getFareConstraintBundle();
				return basicGetFareConstraintBundle();
			case AccountingPackage.FARE_ELEMENT__TEXT:
				if (resolve) return getText();
				return basicGetText();
			case AccountingPackage.FARE_ELEMENT__PRICE:
				if (resolve) return getPrice();
				return basicGetPrice();
			case AccountingPackage.FARE_ELEMENT__REGIONAL_CONSTRAINT:
				if (resolve) return getRegionalConstraint();
				return basicGetRegionalConstraint();
			case AccountingPackage.FARE_ELEMENT__SERVICE_CONSTRAINT:
				if (resolve) return getServiceConstraint();
				return basicGetServiceConstraint();
			case AccountingPackage.FARE_ELEMENT__CARRIER_CONSTRAINT:
				if (resolve) return getCarrierConstraint();
				return basicGetCarrierConstraint();
			case AccountingPackage.FARE_ELEMENT__SERVICE_CLASS:
				if (resolve) return getServiceClass();
				return basicGetServiceClass();
			case AccountingPackage.FARE_ELEMENT__SERVICE_LEVEL:
				if (resolve) return getServiceLevel();
				return basicGetServiceLevel();
			case AccountingPackage.FARE_ELEMENT__SALES_AVAILABILITY:
				if (resolve) return getSalesAvailability();
				return basicGetSalesAvailability();
			case AccountingPackage.FARE_ELEMENT__TRAVEL_VALIDITY:
				if (resolve) return getTravelValidity();
				return basicGetTravelValidity();
			case AccountingPackage.FARE_ELEMENT__COMBINATION_CONSTRAINT:
				if (resolve) return getCombinationConstraint();
				return basicGetCombinationConstraint();
			case AccountingPackage.FARE_ELEMENT__FARE_DETAIL_DESCRIPTION:
				if (resolve) return getFareDetailDescription();
				return basicGetFareDetailDescription();
			case AccountingPackage.FARE_ELEMENT__PERSONAL_DATA_CONSTRAINT:
				if (resolve) return getPersonalDataConstraint();
				return basicGetPersonalDataConstraint();
			case AccountingPackage.FARE_ELEMENT__RESERVATION_PARAMETER:
				if (resolve) return getReservationParameter();
				return basicGetReservationParameter();
			case AccountingPackage.FARE_ELEMENT__REDUCTION_CONSTRAINT:
				if (resolve) return getReductionConstraint();
				return basicGetReductionConstraint();
			case AccountingPackage.FARE_ELEMENT__FULFILLMENT_CONSTRAINT:
				if (resolve) return getFulfillmentConstraint();
				return basicGetFulfillmentConstraint();
			case AccountingPackage.FARE_ELEMENT__PASSENGER_CONSTRAINT:
				if (resolve) return getPassengerConstraint();
				return basicGetPassengerConstraint();
			case AccountingPackage.FARE_ELEMENT__REGULATORY_CONDITIONS:
				return getRegulatoryConditions();
			case AccountingPackage.FARE_ELEMENT__AFTER_SALES_RULE:
				if (resolve) return getAfterSalesRule();
				return basicGetAfterSalesRule();
			case AccountingPackage.FARE_ELEMENT__DATA_SOURCE:
				return getDataSource();
			case AccountingPackage.FARE_ELEMENT__LEGACY_ACCOUNTING_IDENTIFIER:
				return getLegacyAccountingIdentifier();
			case AccountingPackage.FARE_ELEMENT__LEGACY_CONVERSION:
				return getLegacyConversion();
			case AccountingPackage.FARE_ELEMENT__INDIVIDUAL_CONTRACTS:
				return isIndividualContracts();
			case AccountingPackage.FARE_ELEMENT__INVOLVED_TCOS:
				return getInvolvedTcos();
			case AccountingPackage.FARE_ELEMENT__LUGGAGE_CONSTRAINT:
