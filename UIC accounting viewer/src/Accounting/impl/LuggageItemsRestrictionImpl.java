 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.LuggageItemsRestrictionImpl#getNumberOfItems <em>Number Of Items</em>}</li>
 *   <li>{@link Accounting.impl.LuggageItemsRestrictionImpl#getDimension <em>Dimension</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LuggageItemsRestrictionImpl extends MinimalEObjectImpl.Container implements LuggageItemsRestriction {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.LUGGAGE_ITEMS_RESTRICTION;
	}
	...
	public void setNumberOfItems(int newNumberOfItems) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.LUGGAGE_ITEMS_RESTRICTION__NUMBER_OF_ITEMS, oldNumberOfItems, numberOfItems));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AccountingPackage.LUGGAGE_ITEMS_RESTRICTION__DIMENSION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.LUGGAGE_ITEMS_RESTRICTION__NUMBER_OF_ITEMS:
