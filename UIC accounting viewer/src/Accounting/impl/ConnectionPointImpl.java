 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.ConnectionPointImpl#getId <em>Id</em>}</li>
 *   <li>{@link Accounting.impl.ConnectionPointImpl#getName <em>Name</em>}</li>
 *   <li>{@link Accounting.impl.ConnectionPointImpl#getLegacyBorderPointCode <em>Legacy Border Point Code</em>}</li>
 *   <li>{@link Accounting.impl.ConnectionPointImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link Accounting.impl.ConnectionPointImpl#getConnectedStationSets <em>Connected Station Sets</em>}</li>
 *   <li>{@link Accounting.impl.ConnectionPointImpl#getDataSource <em>Data Source</em>}</li>
 *   <li>{@link Accounting.impl.ConnectionPointImpl#getNameUtf8 <em>Name Utf8</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConnectionPointImpl extends MinimalEObjectImpl.Container implements ConnectionPoint {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.CONNECTION_POINT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.CONNECTION_POINT__ID, oldId, id));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.CONNECTION_POINT__NAME, oldName, name));
	}
	...
	public void setLegacyBorderPointCode(int newLegacyBorderPointCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.CONNECTION_POINT__LEGACY_BORDER_POINT_CODE, oldLegacyBorderPointCode, legacyBorderPointCode));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.CONNECTION_POINT__DESCRIPTION, oldDescription, description));
	}
	...
	public void setDataSource(DataSource newDataSource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.CONNECTION_POINT__DATA_SOURCE, oldDataSource, dataSource));
	}
	...
	public void setNameUtf8(String newNameUtf8) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.CONNECTION_POINT__NAME_UTF8, oldNameUtf8, nameUtf8));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AccountingPackage.CONNECTION_POINT__CONNECTED_STATION_SETS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.CONNECTION_POINT__ID:
				return getId();
			case AccountingPackage.CONNECTION_POINT__NAME:
				return getName();
			case AccountingPackage.CONNECTION_POINT__LEGACY_BORDER_POINT_CODE:
				return getLegacyBorderPointCode();
			case AccountingPackage.CONNECTION_POINT__DESCRIPTION:
				return getDescription();
			case AccountingPackage.CONNECTION_POINT__CONNECTED_STATION_SETS:
				return getConnectedStationSets();
			case AccountingPackage.CONNECTION_POINT__DATA_SOURCE:
				return getDataSource();
			case AccountingPackage.CONNECTION_POINT__NAME_UTF8:
				return getNameUtf8();
		}
