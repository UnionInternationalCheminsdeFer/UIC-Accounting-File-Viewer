...
import Accounting.TaxScope;
import Accounting.VATDetail;
 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.VATDetailImpl#getAmount <em>Amount</em>}</li>
 *   <li>{@link Accounting.impl.VATDetailImpl#getPercentage <em>Percentage</em>}</li>
 *   <li>{@link Accounting.impl.VATDetailImpl#getCountry <em>Country</em>}</li>
 *   <li>{@link Accounting.impl.VATDetailImpl#getTaxId <em>Tax Id</em>}</li>
 *   <li>{@link Accounting.impl.VATDetailImpl#getScope <em>Scope</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VATDetailImpl extends MinimalEObjectImpl.Container implements VATDetail {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.VAT_DETAIL;
	}
	...
	public void setAmount(float newAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.VAT_DETAIL__AMOUNT, oldAmount, amount));
	}
	...
	public void setPercentage(float newPercentage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.VAT_DETAIL__PERCENTAGE, oldPercentage, percentage));
	}
	...
	public Country getCountry() {
		if (country != null && country.eIsProxy()) {
			...
			if (country != oldCountry) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.VAT_DETAIL__COUNTRY, oldCountry, country));
			}
		}
		return country;
	}
	...
	public void setCountry(Country newCountry) {
		...
		country = newCountry;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.VAT_DETAIL__COUNTRY, oldCountry, country));
	}
	...
	public void setTaxId(String newTaxId) {
		...
		taxId = newTaxId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.VAT_DETAIL__TAX_ID, oldTaxId, taxId));
	}
	...
	public void setScope(TaxScope newScope) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.VAT_DETAIL__SCOPE, oldScope, scope));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.VAT_DETAIL__AMOUNT:
				return getAmount();
			case AccountingPackage.VAT_DETAIL__PERCENTAGE:
				return getPercentage();
			case AccountingPackage.VAT_DETAIL__COUNTRY:
				if (resolve) return getCountry();
				return basicGetCountry();
			case AccountingPackage.VAT_DETAIL__TAX_ID:
				return getTaxId();
			case AccountingPackage.VAT_DETAIL__SCOPE:
				return getScope();
		}
