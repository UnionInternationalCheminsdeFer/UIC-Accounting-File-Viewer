 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.TranslationImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link Accounting.impl.TranslationImpl#getTextUTF8 <em>Text UTF8</em>}</li>
 *   <li>{@link Accounting.impl.TranslationImpl#getTextICAO <em>Text ICAO</em>}</li>
 *   <li>{@link Accounting.impl.TranslationImpl#getShortTextUTF8 <em>Short Text UTF8</em>}</li>
 *   <li>{@link Accounting.impl.TranslationImpl#getShortTextICAO <em>Short Text ICAO</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TranslationImpl extends MinimalEObjectImpl.Container implements Translation {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.TRANSLATION;
	}
		...
		if (language != null && language.eIsProxy()) {
			...
			if (language != oldLanguage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.TRANSLATION__LANGUAGE, oldLanguage, language));
			}
		}
		return language;
	}
	...
	public void setLanguage(Language newLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TRANSLATION__LANGUAGE, oldLanguage, language));
	}
	...
	public void setTextUTF8(String newTextUTF8) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TRANSLATION__TEXT_UTF8, oldTextUTF8, textUTF8));
	}
	...
	public void setTextICAO(String newTextICAO) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TRANSLATION__TEXT_ICAO, oldTextICAO, textICAO));
	}
	...
	public void setShortTextUTF8(String newShortTextUTF8) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TRANSLATION__SHORT_TEXT_UTF8, oldShortTextUTF8, shortTextUTF8));
	}
	...
	public void setShortTextICAO(String newShortTextICAO) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TRANSLATION__SHORT_TEXT_ICAO, oldShortTextICAO, shortTextICAO));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.TRANSLATION__LANGUAGE:
				if (resolve) return getLanguage();
				return basicGetLanguage();
			case AccountingPackage.TRANSLATION__TEXT_UTF8:
				return getTextUTF8();
			case AccountingPackage.TRANSLATION__TEXT_ICAO:
				return getTextICAO();
			case AccountingPackage.TRANSLATION__SHORT_TEXT_UTF8:
				return getShortTextUTF8();
			case AccountingPackage.TRANSLATION__SHORT_TEXT_ICAO:
