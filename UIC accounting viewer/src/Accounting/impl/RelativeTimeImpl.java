...
import Accounting.RelativeTime;
import Accounting.TimeReferenceType;
 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.RelativeTimeImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link Accounting.impl.RelativeTimeImpl#getReference <em>Reference</em>}</li>
 *   <li>{@link Accounting.impl.RelativeTimeImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelativeTimeImpl extends MinimalEObjectImpl.Container implements RelativeTime {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.RELATIVE_TIME;
	}
	...
	public void setUnit(TimeUnit newUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.RELATIVE_TIME__UNIT, oldUnit, unit));
	}
	...
	public void setReference(TimeReferenceType newReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.RELATIVE_TIME__REFERENCE, oldReference, reference));
	}
	...
	public void setValue(int newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.RELATIVE_TIME__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.RELATIVE_TIME__UNIT:
				return getUnit();
			case AccountingPackage.RELATIVE_TIME__REFERENCE:
				return getReference();
			case AccountingPackage.RELATIVE_TIME__VALUE:
				return getValue();
		}
