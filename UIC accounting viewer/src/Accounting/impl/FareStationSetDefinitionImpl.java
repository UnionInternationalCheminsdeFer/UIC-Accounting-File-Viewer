 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.FareStationSetDefinitionImpl#getDataSource <em>Data Source</em>}</li>
 *   <li>{@link Accounting.impl.FareStationSetDefinitionImpl#getCarrier <em>Carrier</em>}</li>
 *   <li>{@link Accounting.impl.FareStationSetDefinitionImpl#getCode <em>Code</em>}</li>
 *   <li>{@link Accounting.impl.FareStationSetDefinitionImpl#getLegacyCode <em>Legacy Code</em>}</li>
 *   <li>{@link Accounting.impl.FareStationSetDefinitionImpl#getId <em>Id</em>}</li>
 *   <li>{@link Accounting.impl.FareStationSetDefinitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link Accounting.impl.FareStationSetDefinitionImpl#getNameUtf8 <em>Name Utf8</em>}</li>
 *   <li>{@link Accounting.impl.FareStationSetDefinitionImpl#getStations <em>Stations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FareStationSetDefinitionImpl extends MinimalEObjectImpl.Container implements FareStationSetDefinition {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.FARE_STATION_SET_DEFINITION;
	}
	...
	public void setDataSource(DataSource newDataSource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STATION_SET_DEFINITION__DATA_SOURCE, oldDataSource, dataSource));
	}
	...
	public Carrier getCarrier() {
		if (carrier != null && carrier.eIsProxy()) {
			...
			if (carrier != oldCarrier) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.FARE_STATION_SET_DEFINITION__CARRIER, oldCarrier, carrier));
			}
		}
		return carrier;
	}
	...
	public void setCarrier(Carrier newCarrier) {
		...
		carrier = newCarrier;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STATION_SET_DEFINITION__CARRIER, oldCarrier, carrier));
	}
	...
	public void setCode(String newCode) {
		...
		code = newCode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STATION_SET_DEFINITION__CODE, oldCode, code));
	}
	...
	public void setLegacyCode(int newLegacyCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STATION_SET_DEFINITION__LEGACY_CODE, oldLegacyCode, legacyCode));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STATION_SET_DEFINITION__ID, oldId, id));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STATION_SET_DEFINITION__NAME, oldName, name));
	}
	...
	public void setNameUtf8(String newNameUtf8) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_STATION_SET_DEFINITION__NAME_UTF8, oldNameUtf8, nameUtf8));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.FARE_STATION_SET_DEFINITION__DATA_SOURCE:
				return getDataSource();
			case AccountingPackage.FARE_STATION_SET_DEFINITION__CARRIER:
				if (resolve) return getCarrier();
				return basicGetCarrier();
			case AccountingPackage.FARE_STATION_SET_DEFINITION__CODE:
				return getCode();
			case AccountingPackage.FARE_STATION_SET_DEFINITION__LEGACY_CODE:
				return getLegacyCode();
			case AccountingPackage.FARE_STATION_SET_DEFINITION__ID:
				return getId();
			case AccountingPackage.FARE_STATION_SET_DEFINITION__NAME:
				return getName();
			case AccountingPackage.FARE_STATION_SET_DEFINITION__NAME_UTF8:
				return getNameUtf8();
			case AccountingPackage.FARE_STATION_SET_DEFINITION__STATIONS:
				return getStations();
		}
