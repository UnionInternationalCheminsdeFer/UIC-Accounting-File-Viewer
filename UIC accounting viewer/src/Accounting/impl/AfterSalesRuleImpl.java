 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.AfterSalesRuleImpl#getId <em>Id</em>}</li>
 *   <li>{@link Accounting.impl.AfterSalesRuleImpl#getDataSource <em>Data Source</em>}</li>
 *   <li>{@link Accounting.impl.AfterSalesRuleImpl#getConditions <em>Conditions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AfterSalesRuleImpl extends MinimalEObjectImpl.Container implements AfterSalesRule {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.AFTER_SALES_RULE;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.AFTER_SALES_RULE__ID, oldId, id));
	}
	...
	public void setDataSource(DataSource newDataSource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.AFTER_SALES_RULE__DATA_SOURCE, oldDataSource, dataSource));
	}
	...
	public EList<AfterSalesCondition> getConditions() {
		if (conditions == null) {
			conditions = new EObjectContainmentEList<AfterSalesCondition>(AfterSalesCondition.class, this, AccountingPackage.AFTER_SALES_RULE__CONDITIONS);
		}
		return conditions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AccountingPackage.AFTER_SALES_RULE__CONDITIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.AFTER_SALES_RULE__ID:
				return getId();
			case AccountingPackage.AFTER_SALES_RULE__DATA_SOURCE:
