...
import Accounting.ExcludedTimeRange;
import Accounting.ReturnValidityConstraint;
import Accounting.TrainValidity;
import Accounting.TravelValidityConstraint;
import Accounting.TravelValidityType;
import Accounting.TripAllocationConstraint;
import Accounting.TripInterruptionConstraint;
import Accounting.ValidityRange;
 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.TravelValidityConstraintImpl#getId <em>Id</em>}</li>
 *   <li>{@link Accounting.impl.TravelValidityConstraintImpl#getDataDescription <em>Data Description</em>}</li>
 *   <li>{@link Accounting.impl.TravelValidityConstraintImpl#getValidDays <em>Valid Days</em>}</li>
 *   <li>{@link Accounting.impl.TravelValidityConstraintImpl#getTravelDays <em>Travel Days</em>}</li>
 *   <li>{@link Accounting.impl.TravelValidityConstraintImpl#getRange <em>Range</em>}</li>
 *   <li>{@link Accounting.impl.TravelValidityConstraintImpl#getReturnConstraint <em>Return Constraint</em>}</li>
 *   <li>{@link Accounting.impl.TravelValidityConstraintImpl#getExcludedTimeRange <em>Excluded Time Range</em>}</li>
 *   <li>{@link Accounting.impl.TravelValidityConstraintImpl#getTrainValidity <em>Train Validity</em>}</li>
 *   <li>{@link Accounting.impl.TravelValidityConstraintImpl#getValidityType <em>Validity Type</em>}</li>
 *   <li>{@link Accounting.impl.TravelValidityConstraintImpl#getTripInterruptionConstraint <em>Trip Interruption Constraint</em>}</li>
 *   <li>{@link Accounting.impl.TravelValidityConstraintImpl#getTripAllocationConstraint <em>Trip Allocation Constraint</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TravelValidityConstraintImpl extends MinimalEObjectImpl.Container implements TravelValidityConstraint {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.TRAVEL_VALIDITY_CONSTRAINT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TRAVEL_VALIDITY_CONSTRAINT__ID, oldId, id));
	}
	...
	public void setDataDescription(String newDataDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TRAVEL_VALIDITY_CONSTRAINT__DATA_DESCRIPTION, oldDataDescription, dataDescription));
	}
	...
	public Calendar getValidDays() {
		if (validDays != null && validDays.eIsProxy()) {
			...
			if (validDays != oldValidDays) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.TRAVEL_VALIDITY_CONSTRAINT__VALID_DAYS, oldValidDays, validDays));
			}
		}
		return validDays;
	}
	...
	public void setValidDays(Calendar newValidDays) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TRAVEL_VALIDITY_CONSTRAINT__VALID_DAYS, oldValidDays, validDays));
	}
	...
	public void setTravelDays(int newTravelDays) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TRAVEL_VALIDITY_CONSTRAINT__TRAVEL_DAYS, oldTravelDays, travelDays));
	}
	...
	public NotificationChain basicSetRange(ValidityRange newRange, NotificationChain msgs) {
		...
		range = newRange;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.TRAVEL_VALIDITY_CONSTRAINT__RANGE, oldRange, newRange);
	...
	public void setRange(ValidityRange newRange) {
		if (newRange != range) {
			...
			if (range != null)
				msgs = ((InternalEObject)range).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.TRAVEL_VALIDITY_CONSTRAINT__RANGE, null, msgs);
			if (newRange != null)
				msgs = ((InternalEObject)newRange).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.TRAVEL_VALIDITY_CONSTRAINT__RANGE, null, msgs);
			msgs = basicSetRange(newRange, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TRAVEL_VALIDITY_CONSTRAINT__RANGE, newRange, newRange));
	}
	...
	public NotificationChain basicSetReturnConstraint(ReturnValidityConstraint newReturnConstraint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.TRAVEL_VALIDITY_CONSTRAINT__RETURN_CONSTRAINT, oldReturnConstraint, newReturnConstraint);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setReturnConstraint(ReturnValidityConstraint newReturnConstraint) {
		if (newReturnConstraint != returnConstraint) {
			...
			if (returnConstraint != null)
				msgs = ((InternalEObject)returnConstraint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.TRAVEL_VALIDITY_CONSTRAINT__RETURN_CONSTRAINT, null, msgs);
			if (newReturnConstraint != null)
				msgs = ((InternalEObject)newReturnConstraint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.TRAVEL_VALIDITY_CONSTRAINT__RETURN_CONSTRAINT, null, msgs);
			msgs = basicSetReturnConstraint(newReturnConstraint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TRAVEL_VALIDITY_CONSTRAINT__RETURN_CONSTRAINT, newReturnConstraint, newReturnConstraint));
	}
	...
	public NotificationChain basicSetTrainValidity(TrainValidity newTrainValidity, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.TRAVEL_VALIDITY_CONSTRAINT__TRAIN_VALIDITY, oldTrainValidity, newTrainValidity);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTrainValidity(TrainValidity newTrainValidity) {
		if (newTrainValidity != trainValidity) {
			...
			if (trainValidity != null)
				msgs = ((InternalEObject)trainValidity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.TRAVEL_VALIDITY_CONSTRAINT__TRAIN_VALIDITY, null, msgs);
			if (newTrainValidity != null)
				msgs = ((InternalEObject)newTrainValidity).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.TRAVEL_VALIDITY_CONSTRAINT__TRAIN_VALIDITY, null, msgs);
			msgs = basicSetTrainValidity(newTrainValidity, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TRAVEL_VALIDITY_CONSTRAINT__TRAIN_VALIDITY, newTrainValidity, newTrainValidity));
	}
	...
	public void setValidityType(TravelValidityType newValidityType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TRAVEL_VALIDITY_CONSTRAINT__VALIDITY_TYPE, oldValidityType, validityType));
	}
	...
	public NotificationChain basicSetTripInterruptionConstraint(TripInterruptionConstraint newTripInterruptionConstraint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.TRAVEL_VALIDITY_CONSTRAINT__TRIP_INTERRUPTION_CONSTRAINT, oldTripInterruptionConstraint, newTripInterruptionConstraint);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTripInterruptionConstraint(TripInterruptionConstraint newTripInterruptionConstraint) {
		if (newTripInterruptionConstraint != tripInterruptionConstraint) {
			...
			if (tripInterruptionConstraint != null)
				msgs = ((InternalEObject)tripInterruptionConstraint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.TRAVEL_VALIDITY_CONSTRAINT__TRIP_INTERRUPTION_CONSTRAINT, null, msgs);
			if (newTripInterruptionConstraint != null)
				msgs = ((InternalEObject)newTripInterruptionConstraint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.TRAVEL_VALIDITY_CONSTRAINT__TRIP_INTERRUPTION_CONSTRAINT, null, msgs);
			msgs = basicSetTripInterruptionConstraint(newTripInterruptionConstraint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TRAVEL_VALIDITY_CONSTRAINT__TRIP_INTERRUPTION_CONSTRAINT, newTripInterruptionConstraint, newTripInterruptionConstraint));
	}
	...
	public NotificationChain basicSetTripAllocationConstraint(TripAllocationConstraint newTripAllocationConstraint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.TRAVEL_VALIDITY_CONSTRAINT__TRIP_ALLOCATION_CONSTRAINT, oldTripAllocationConstraint, newTripAllocationConstraint);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTripAllocationConstraint(TripAllocationConstraint newTripAllocationConstraint) {
		if (newTripAllocationConstraint != tripAllocationConstraint) {
			...
			if (tripAllocationConstraint != null)
				msgs = ((InternalEObject)tripAllocationConstraint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.TRAVEL_VALIDITY_CONSTRAINT__TRIP_ALLOCATION_CONSTRAINT, null, msgs);
			if (newTripAllocationConstraint != null)
				msgs = ((InternalEObject)newTripAllocationConstraint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.TRAVEL_VALIDITY_CONSTRAINT__TRIP_ALLOCATION_CONSTRAINT, null, msgs);
			msgs = basicSetTripAllocationConstraint(newTripAllocationConstraint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TRAVEL_VALIDITY_CONSTRAINT__TRIP_ALLOCATION_CONSTRAINT, newTripAllocationConstraint, newTripAllocationConstraint));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case AccountingPackage.TRAVEL_VALIDITY_CONSTRAINT__VALID_DAYS:
