...
import Accounting.OnlineServiceType;
 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.SupportedOnlineServicesImpl#getSupportedOnlineServices <em>Supported Online Services</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SupportedOnlineServicesImpl extends MinimalEObjectImpl.Container implements SupportedOnlineServices {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.SUPPORTED_ONLINE_SERVICES;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.SUPPORTED_ONLINE_SERVICES__SUPPORTED_ONLINE_SERVICES:
