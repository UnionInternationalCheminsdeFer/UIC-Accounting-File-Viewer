...
import Accounting.GraphicalReservationType;
import Accounting.ReservationOptions;
import Accounting.ReservationPreferenceGroup;
 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.ReservationOptionsImpl#getPreferences <em>Preferences</em>}</li>
 *   <li>{@link Accounting.impl.ReservationOptionsImpl#getServiceBrands <em>Service Brands</em>}</li>
 *   <li>{@link Accounting.impl.ReservationOptionsImpl#getGraphicalReservation <em>Graphical Reservation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReservationOptionsImpl extends MinimalEObjectImpl.Container implements ReservationOptions {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.RESERVATION_OPTIONS;
	}
	...
	public void setGraphicalReservation(GraphicalReservationType newGraphicalReservation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.RESERVATION_OPTIONS__GRAPHICAL_RESERVATION, oldGraphicalReservation, graphicalReservation));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AccountingPackage.RESERVATION_OPTIONS__PREFERENCES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case AccountingPackage.RESERVATION_OPTIONS__SERVICE_BRANDS:
				return getServiceBrands();
			case AccountingPackage.RESERVATION_OPTIONS__GRAPHICAL_RESERVATION:
