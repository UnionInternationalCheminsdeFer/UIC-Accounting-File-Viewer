...
import Accounting.TripInterruptionProcess;
 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.TripInterruptionConstraintImpl#getMaxInterruptions <em>Max Interruptions</em>}</li>
 *   <li>{@link Accounting.impl.TripInterruptionConstraintImpl#getMaxDuration <em>Max Duration</em>}</li>
 *   <li>{@link Accounting.impl.TripInterruptionConstraintImpl#getTotalMaxDuration <em>Total Max Duration</em>}</li>
 *   <li>{@link Accounting.impl.TripInterruptionConstraintImpl#getRequiredProcesses <em>Required Processes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TripInterruptionConstraintImpl extends MinimalEObjectImpl.Container implements TripInterruptionConstraint {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.TRIP_INTERRUPTION_CONSTRAINT;
	}
	...
	public void setMaxInterruptions(int newMaxInterruptions) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TRIP_INTERRUPTION_CONSTRAINT__MAX_INTERRUPTIONS, oldMaxInterruptions, maxInterruptions));
	}
	...
	public void setMaxDuration(String newMaxDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TRIP_INTERRUPTION_CONSTRAINT__MAX_DURATION, oldMaxDuration, maxDuration));
	}
	...
	public void setTotalMaxDuration(String newTotalMaxDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.TRIP_INTERRUPTION_CONSTRAINT__TOTAL_MAX_DURATION, oldTotalMaxDuration, totalMaxDuration));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.TRIP_INTERRUPTION_CONSTRAINT__MAX_INTERRUPTIONS:
				return getMaxInterruptions();
			case AccountingPackage.TRIP_INTERRUPTION_CONSTRAINT__MAX_DURATION:
				return getMaxDuration();
			case AccountingPackage.TRIP_INTERRUPTION_CONSTRAINT__TOTAL_MAX_DURATION:
				return getTotalMaxDuration();
			case AccountingPackage.TRIP_INTERRUPTION_CONSTRAINT__REQUIRED_PROCESSES:
