 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.LineImpl#getBinaryZoneId <em>Binary Zone Id</em>}</li>
 *   <li>{@link Accounting.impl.LineImpl#getLineId <em>Line Id</em>}</li>
 *   <li>{@link Accounting.impl.LineImpl#getCarrier <em>Carrier</em>}</li>
 *   <li>{@link Accounting.impl.LineImpl#getEntryStation <em>Entry Station</em>}</li>
 *   <li>{@link Accounting.impl.LineImpl#getTerminalStation <em>Terminal Station</em>}</li>
 *   <li>{@link Accounting.impl.LineImpl#getNutsCode <em>Nuts Code</em>}</li>
 *   <li>{@link Accounting.impl.LineImpl#getCity <em>City</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LineImpl extends MinimalEObjectImpl.Container implements Line {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.LINE;
	}
	...
	public void setBinaryZoneId(byte[] newBinaryZoneId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.LINE__BINARY_ZONE_ID, oldBinaryZoneId, binaryZoneId));
	}
	...
	public Carrier getCarrier() {
		if (carrier != null && carrier.eIsProxy()) {
			...
			if (carrier != oldCarrier) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.LINE__CARRIER, oldCarrier, carrier));
			}
		}
		return carrier;
	}
	...
	public void setCarrier(Carrier newCarrier) {
		...
		carrier = newCarrier;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.LINE__CARRIER, oldCarrier, carrier));
	}
	...
	public Station getEntryStation() {
		if (entryStation != null && entryStation.eIsProxy()) {
			...
			if (entryStation != oldEntryStation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.LINE__ENTRY_STATION, oldEntryStation, entryStation));
			}
		}
		return entryStation;
	}
	...
	public void setEntryStation(Station newEntryStation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.LINE__ENTRY_STATION, oldEntryStation, entryStation));
	}
	...
	public Station getTerminalStation() {
		if (terminalStation != null && terminalStation.eIsProxy()) {
			...
			if (terminalStation != oldTerminalStation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.LINE__TERMINAL_STATION, oldTerminalStation, terminalStation));
			}
		}
	...
	public void setTerminalStation(Station newTerminalStation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.LINE__TERMINAL_STATION, oldTerminalStation, terminalStation));
	}
	...
	public NutsCode getNutsCode() {
		if (nutsCode != null && nutsCode.eIsProxy()) {
			...
			if (nutsCode != oldNutsCode) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.LINE__NUTS_CODE, oldNutsCode, nutsCode));
			}
		}
		return nutsCode;
	}
	...
	public void setNutsCode(NutsCode newNutsCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.LINE__NUTS_CODE, oldNutsCode, nutsCode));
	}
	...
	public void setCity(int newCity) {
		...
		city = newCity;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.LINE__CITY, oldCity, city));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.LINE__BINARY_ZONE_ID:
				return getBinaryZoneId();
			case AccountingPackage.LINE__LINE_ID:
				return getLineId();
			case AccountingPackage.LINE__CARRIER:
				if (resolve) return getCarrier();
				return basicGetCarrier();
			case AccountingPackage.LINE__ENTRY_STATION:
				if (resolve) return getEntryStation();
				return basicGetEntryStation();
			case AccountingPackage.LINE__TERMINAL_STATION:
				if (resolve) return getTerminalStation();
				return basicGetTerminalStation();
			case AccountingPackage.LINE__NUTS_CODE:
				if (resolve) return getNutsCode();
				return basicGetNutsCode();
			case AccountingPackage.LINE__CITY:
				return getCity();
		}
