...
import Accounting.ReservationOptions;
import Accounting.ReservationParameter;
import Accounting.ReservationParams9181;
import Accounting.ServiceBrand;
import Accounting.ServiceMode;
 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.ReservationParameterImpl#isMandatoryReservation <em>Mandatory Reservation</em>}</li>
 *   <li>{@link Accounting.impl.ReservationParameterImpl#getId <em>Id</em>}</li>
 *   <li>{@link Accounting.impl.ReservationParameterImpl#getParams9181 <em>Params9181</em>}</li>
 *   <li>{@link Accounting.impl.ReservationParameterImpl#getOptions <em>Options</em>}</li>
 *   <li>{@link Accounting.impl.ReservationParameterImpl#getMandatoryReservationForBrands <em>Mandatory Reservation For Brands</em>}</li>
 *   <li>{@link Accounting.impl.ReservationParameterImpl#getMandatoryReservationsForMode <em>Mandatory Reservations For Mode</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReservationParameterImpl extends MinimalEObjectImpl.Container implements ReservationParameter {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.RESERVATION_PARAMETER;
	}
	...
	public void setMandatoryReservation(boolean newMandatoryReservation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.RESERVATION_PARAMETER__MANDATORY_RESERVATION, oldMandatoryReservation, mandatoryReservation));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.RESERVATION_PARAMETER__ID, oldId, id));
	}
	...
	public NotificationChain basicSetParams9181(ReservationParams9181 newParams9181, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.RESERVATION_PARAMETER__PARAMS9181, oldParams9181, newParams9181);
	...
	public void setParams9181(ReservationParams9181 newParams9181) {
		if (newParams9181 != params9181) {
			...
			if (params9181 != null)
				msgs = ((InternalEObject)params9181).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.RESERVATION_PARAMETER__PARAMS9181, null, msgs);
			if (newParams9181 != null)
				msgs = ((InternalEObject)newParams9181).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.RESERVATION_PARAMETER__PARAMS9181, null, msgs);
			msgs = basicSetParams9181(newParams9181, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.RESERVATION_PARAMETER__PARAMS9181, newParams9181, newParams9181));
	}
	...
	public NotificationChain basicSetOptions(ReservationOptions newOptions, NotificationChain msgs) {
		...
		options = newOptions;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.RESERVATION_PARAMETER__OPTIONS, oldOptions, newOptions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOptions(ReservationOptions newOptions) {
		if (newOptions != options) {
			NotificationChain msgs = null;
			if (options != null)
				msgs = ((InternalEObject)options).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.RESERVATION_PARAMETER__OPTIONS, null, msgs);
			if (newOptions != null)
				msgs = ((InternalEObject)newOptions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.RESERVATION_PARAMETER__OPTIONS, null, msgs);
			msgs = basicSetOptions(newOptions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.RESERVATION_PARAMETER__OPTIONS, newOptions, newOptions));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AccountingPackage.RESERVATION_PARAMETER__PARAMS9181:
				return basicSetParams9181(null, msgs);
			case AccountingPackage.RESERVATION_PARAMETER__OPTIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.RESERVATION_PARAMETER__MANDATORY_RESERVATION:
				return isMandatoryReservation();
			case AccountingPackage.RESERVATION_PARAMETER__ID:
				return getId();
			case AccountingPackage.RESERVATION_PARAMETER__PARAMS9181:
				return getParams9181();
			case AccountingPackage.RESERVATION_PARAMETER__OPTIONS:
				return getOptions();
			case AccountingPackage.RESERVATION_PARAMETER__MANDATORY_RESERVATION_FOR_BRANDS:
				return getMandatoryReservationForBrands();
			case AccountingPackage.RESERVATION_PARAMETER__MANDATORY_RESERVATIONS_FOR_MODE:
