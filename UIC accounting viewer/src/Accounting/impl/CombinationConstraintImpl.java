 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.CombinationConstraintImpl#getId <em>Id</em>}</li>
 *   <li>{@link Accounting.impl.CombinationConstraintImpl#getDataDescription <em>Data Description</em>}</li>
 *   <li>{@link Accounting.impl.CombinationConstraintImpl#getCombinationModels <em>Combination Models</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CombinationConstraintImpl extends MinimalEObjectImpl.Container implements CombinationConstraint {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.COMBINATION_CONSTRAINT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.COMBINATION_CONSTRAINT__ID, oldId, id));
	}
	...
	public void setDataDescription(String newDataDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.COMBINATION_CONSTRAINT__DATA_DESCRIPTION, oldDataDescription, dataDescription));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AccountingPackage.COMBINATION_CONSTRAINT__COMBINATION_MODELS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.COMBINATION_CONSTRAINT__ID:
				return getId();
			case AccountingPackage.COMBINATION_CONSTRAINT__DATA_DESCRIPTION:
