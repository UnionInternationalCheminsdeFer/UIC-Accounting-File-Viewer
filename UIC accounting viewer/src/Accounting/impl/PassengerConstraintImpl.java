...
import Accounting.IncludedFreePassengerLimit;
import Accounting.PassengerCombinationConstraint;
 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.PassengerConstraintImpl#getId <em>Id</em>}</li>
 *   <li>{@link Accounting.impl.PassengerConstraintImpl#getTravelerType <em>Traveler Type</em>}</li>
 *   <li>{@link Accounting.impl.PassengerConstraintImpl#getText <em>Text</em>}</li>
 *   <li>{@link Accounting.impl.PassengerConstraintImpl#getUpperAgeLimit <em>Upper Age Limit</em>}</li>
 *   <li>{@link Accounting.impl.PassengerConstraintImpl#getLowerAgeLimit <em>Lower Age Limit</em>}</li>
 *   <li>{@link Accounting.impl.PassengerConstraintImpl#getTravelAloneAgeLimit <em>Travel Alone Age Limit</em>}</li>
 *   <li>{@link Accounting.impl.PassengerConstraintImpl#getReservationAgeLimit <em>Reservation Age Limit</em>}</li>
 *   <li>{@link Accounting.impl.PassengerConstraintImpl#isIsAncilliary <em>Is Ancilliary</em>}</li>
 *   <li>{@link Accounting.impl.PassengerConstraintImpl#getPassengerWeight <em>Passenger Weight</em>}</li>
 *   <li>{@link Accounting.impl.PassengerConstraintImpl#getMaxTotalPassengerWeight <em>Max Total Passenger Weight</em>}</li>
 *   <li>{@link Accounting.impl.PassengerConstraintImpl#getMinTotalPassengerWeight <em>Min Total Passenger Weight</em>}</li>
 *   <li>{@link Accounting.impl.PassengerConstraintImpl#getIncludedFreePassengers <em>Included Free Passengers</em>}</li>
 *   <li>{@link Accounting.impl.PassengerConstraintImpl#getExcludedPassengerCombinations <em>Excluded Passenger Combinations</em>}</li>
 *   <li>{@link Accounting.impl.PassengerConstraintImpl#getDataDescription <em>Data Description</em>}</li>
 *   <li>{@link Accounting.impl.PassengerConstraintImpl#getDataSource <em>Data Source</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PassengerConstraintImpl extends MinimalEObjectImpl.Container implements PassengerConstraint {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.PASSENGER_CONSTRAINT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.PASSENGER_CONSTRAINT__ID, oldId, id));
	}
	...
	public void setTravelerType(TravelerType newTravelerType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.PASSENGER_CONSTRAINT__TRAVELER_TYPE, oldTravelerType, travelerType));
	}
	...
	public Text getText() {
		if (text != null && text.eIsProxy()) {
			...
			if (text != oldText) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.PASSENGER_CONSTRAINT__TEXT, oldText, text));
			}
		}
		return text;
	}
	...
	public void setText(Text newText) {
		...
		text = newText;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.PASSENGER_CONSTRAINT__TEXT, oldText, text));
	}
	...
	public void setUpperAgeLimit(int newUpperAgeLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.PASSENGER_CONSTRAINT__UPPER_AGE_LIMIT, oldUpperAgeLimit, upperAgeLimit));
	}
	...
	public void setLowerAgeLimit(int newLowerAgeLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.PASSENGER_CONSTRAINT__LOWER_AGE_LIMIT, oldLowerAgeLimit, lowerAgeLimit));
	}
	...
	public void setTravelAloneAgeLimit(int newTravelAloneAgeLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.PASSENGER_CONSTRAINT__TRAVEL_ALONE_AGE_LIMIT, oldTravelAloneAgeLimit, travelAloneAgeLimit));
	}
	...
	public void setReservationAgeLimit(int newReservationAgeLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.PASSENGER_CONSTRAINT__RESERVATION_AGE_LIMIT, oldReservationAgeLimit, reservationAgeLimit));
	}
	...
	public void setIsAncilliary(boolean newIsAncilliary) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.PASSENGER_CONSTRAINT__IS_ANCILLIARY, oldIsAncilliary, isAncilliary));
	}
	...
	public void setPassengerWeight(float newPassengerWeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.PASSENGER_CONSTRAINT__PASSENGER_WEIGHT, oldPassengerWeight, passengerWeight));
	}
	...
	public void setMaxTotalPassengerWeight(float newMaxTotalPassengerWeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.PASSENGER_CONSTRAINT__MAX_TOTAL_PASSENGER_WEIGHT, oldMaxTotalPassengerWeight, maxTotalPassengerWeight));
	}
	...
	public void setMinTotalPassengerWeight(float newMinTotalPassengerWeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.PASSENGER_CONSTRAINT__MIN_TOTAL_PASSENGER_WEIGHT, oldMinTotalPassengerWeight, minTotalPassengerWeight));
	}
	...
	public void setDataDescription(String newDataDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.PASSENGER_CONSTRAINT__DATA_DESCRIPTION, oldDataDescription, dataDescription));
	}
	...
	public void setDataSource(DataSource newDataSource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.PASSENGER_CONSTRAINT__DATA_SOURCE, oldDataSource, dataSource));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AccountingPackage.PASSENGER_CONSTRAINT__INCLUDED_FREE_PASSENGERS:
				return ((InternalEList<?>)getIncludedFreePassengers()).basicRemove(otherEnd, msgs);
			case AccountingPackage.PASSENGER_CONSTRAINT__EXCLUDED_PASSENGER_COMBINATIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.PASSENGER_CONSTRAINT__ID:
				return getId();
			case AccountingPackage.PASSENGER_CONSTRAINT__TRAVELER_TYPE:
				return getTravelerType();
			case AccountingPackage.PASSENGER_CONSTRAINT__TEXT:
				if (resolve) return getText();
				return basicGetText();
			case AccountingPackage.PASSENGER_CONSTRAINT__UPPER_AGE_LIMIT:
				return getUpperAgeLimit();
			case AccountingPackage.PASSENGER_CONSTRAINT__LOWER_AGE_LIMIT:
				return getLowerAgeLimit();
			case AccountingPackage.PASSENGER_CONSTRAINT__TRAVEL_ALONE_AGE_LIMIT:
				return getTravelAloneAgeLimit();
			case AccountingPackage.PASSENGER_CONSTRAINT__RESERVATION_AGE_LIMIT:
				return getReservationAgeLimit();
			case AccountingPackage.PASSENGER_CONSTRAINT__IS_ANCILLIARY:
				return isIsAncilliary();
			case AccountingPackage.PASSENGER_CONSTRAINT__PASSENGER_WEIGHT:
				return getPassengerWeight();
			case AccountingPackage.PASSENGER_CONSTRAINT__MAX_TOTAL_PASSENGER_WEIGHT:
				return getMaxTotalPassengerWeight();
			case AccountingPackage.PASSENGER_CONSTRAINT__MIN_TOTAL_PASSENGER_WEIGHT:
				return getMinTotalPassengerWeight();
			case AccountingPackage.PASSENGER_CONSTRAINT__INCLUDED_FREE_PASSENGERS:
				return getIncludedFreePassengers();
			case AccountingPackage.PASSENGER_CONSTRAINT__EXCLUDED_PASSENGER_COMBINATIONS:
				return getExcludedPassengerCombinations();
			case AccountingPackage.PASSENGER_CONSTRAINT__DATA_DESCRIPTION:
				return getDataDescription();
			case AccountingPackage.PASSENGER_CONSTRAINT__DATA_SOURCE:
