 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.FareCombinationModelImpl#getModel <em>Model</em>}</li>
 *   <li>{@link Accounting.impl.FareCombinationModelImpl#getCombinableCarriers <em>Combinable Carriers</em>}</li>
 *   <li>{@link Accounting.impl.FareCombinationModelImpl#isOnlyWhenCombined <em>Only When Combined</em>}</li>
 *   <li>{@link Accounting.impl.FareCombinationModelImpl#getAllowedAllocators <em>Allowed Allocators</em>}</li>
 *   <li>{@link Accounting.impl.FareCombinationModelImpl#getReferenceCluster <em>Reference Cluster</em>}</li>
 *   <li>{@link Accounting.impl.FareCombinationModelImpl#getAllowedClusters <em>Allowed Clusters</em>}</li>
 *   <li>{@link Accounting.impl.FareCombinationModelImpl#getAllowedCommonContracts <em>Allowed Common Contracts</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FareCombinationModelImpl extends MinimalEObjectImpl.Container implements FareCombinationModel {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.FARE_COMBINATION_MODEL;
	}
	...
	public void setModel(CombinationModel newModel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_COMBINATION_MODEL__MODEL, oldModel, model));
	}
	...
	public void setOnlyWhenCombined(boolean newOnlyWhenCombined) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_COMBINATION_MODEL__ONLY_WHEN_COMBINED, oldOnlyWhenCombined, onlyWhenCombined));
	}
	...
	public void setReferenceCluster(Clusters newReferenceCluster) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_COMBINATION_MODEL__REFERENCE_CLUSTER, oldReferenceCluster, referenceCluster));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.FARE_COMBINATION_MODEL__MODEL:
				return getModel();
			case AccountingPackage.FARE_COMBINATION_MODEL__COMBINABLE_CARRIERS:
				return getCombinableCarriers();
			case AccountingPackage.FARE_COMBINATION_MODEL__ONLY_WHEN_COMBINED:
				return isOnlyWhenCombined();
			case AccountingPackage.FARE_COMBINATION_MODEL__ALLOWED_ALLOCATORS:
			...
			case AccountingPackage.FARE_COMBINATION_MODEL__ALLOWED_COMMON_CONTRACTS:
