...
import Accounting.CurrencyPrice;
 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.CurrencyPriceImpl#getCurrency <em>Currency</em>}</li>
 *   <li>{@link Accounting.impl.CurrencyPriceImpl#getAmount <em>Amount</em>}</li>
 *   <li>{@link Accounting.impl.CurrencyPriceImpl#getVATdetails <em>VA Tdetails</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CurrencyPriceImpl extends MinimalEObjectImpl.Container implements CurrencyPrice {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.CURRENCY_PRICE;
	}
		...
		if (currency != null && currency.eIsProxy()) {
			...
			if (currency != oldCurrency) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountingPackage.CURRENCY_PRICE__CURRENCY, oldCurrency, currency));
			}
		}
		return currency;
	}
	...
	public void setCurrency(Currency newCurrency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.CURRENCY_PRICE__CURRENCY, oldCurrency, currency));
	}
	...
	public void setAmount(float newAmount) {
		...
		amount = newAmount;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.CURRENCY_PRICE__AMOUNT, oldAmount, amount));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AccountingPackage.CURRENCY_PRICE__VA_TDETAILS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.CURRENCY_PRICE__CURRENCY:
				if (resolve) return getCurrency();
				return basicGetCurrency();
			case AccountingPackage.CURRENCY_PRICE__AMOUNT:
				return getAmount();
			case AccountingPackage.CURRENCY_PRICE__VA_TDETAILS:
