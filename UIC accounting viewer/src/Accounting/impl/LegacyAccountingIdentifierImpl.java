 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.LegacyAccountingIdentifierImpl#getSeriesId <em>Series Id</em>}</li>
 *   <li>{@link Accounting.impl.LegacyAccountingIdentifierImpl#getTariffId <em>Tariff Id</em>}</li>
 *   <li>{@link Accounting.impl.LegacyAccountingIdentifierImpl#getAddSeriesId <em>Add Series Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LegacyAccountingIdentifierImpl extends MinimalEObjectImpl.Container implements LegacyAccountingIdentifier {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.LEGACY_ACCOUNTING_IDENTIFIER;
	}
	...
	public void setSeriesId(int newSeriesId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.LEGACY_ACCOUNTING_IDENTIFIER__SERIES_ID, oldSeriesId, seriesId));
	}
	...
	public void setTariffId(int newTariffId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.LEGACY_ACCOUNTING_IDENTIFIER__TARIFF_ID, oldTariffId, tariffId));
	}
	...
	public void setAddSeriesId(int newAddSeriesId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.LEGACY_ACCOUNTING_IDENTIFIER__ADD_SERIES_ID, oldAddSeriesId, addSeriesId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AccountingPackage.LEGACY_ACCOUNTING_IDENTIFIER__SERIES_ID:
				return getSeriesId();
			case AccountingPackage.LEGACY_ACCOUNTING_IDENTIFIER__TARIFF_ID:
				return getTariffId();
			case AccountingPackage.LEGACY_ACCOUNTING_IDENTIFIER__ADD_SERIES_ID:
