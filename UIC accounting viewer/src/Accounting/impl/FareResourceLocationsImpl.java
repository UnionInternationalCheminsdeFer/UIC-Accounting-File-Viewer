...
import Accounting.CarrierResourceLocations;
import Accounting.FareResourceLocations;
import Accounting.StationResourceLocations;
import Accounting.TrainResourceLocations;
 ...
 * </p>
 * <ul>
 *   <li>{@link Accounting.impl.FareResourceLocationsImpl#getTrainResourceLocations <em>Train Resource Locations</em>}</li>
 *   <li>{@link Accounting.impl.FareResourceLocationsImpl#getStationResourceLocations <em>Station Resource Locations</em>}</li>
 *   <li>{@link Accounting.impl.FareResourceLocationsImpl#getCarrierResourceLocations <em>Carrier Resource Locations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FareResourceLocationsImpl extends MinimalEObjectImpl.Container implements FareResourceLocations {
	...
	protected EClass eStaticClass() {
		return AccountingPackage.Literals.FARE_RESOURCE_LOCATIONS;
	}
	...
	public NotificationChain basicSetTrainResourceLocations(TrainResourceLocations newTrainResourceLocations, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_RESOURCE_LOCATIONS__TRAIN_RESOURCE_LOCATIONS, oldTrainResourceLocations, newTrainResourceLocations);
	...
	public void setTrainResourceLocations(TrainResourceLocations newTrainResourceLocations) {
		if (newTrainResourceLocations != trainResourceLocations) {
			...
			if (trainResourceLocations != null)
				msgs = ((InternalEObject)trainResourceLocations).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_RESOURCE_LOCATIONS__TRAIN_RESOURCE_LOCATIONS, null, msgs);
			if (newTrainResourceLocations != null)
				msgs = ((InternalEObject)newTrainResourceLocations).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_RESOURCE_LOCATIONS__TRAIN_RESOURCE_LOCATIONS, null, msgs);
			msgs = basicSetTrainResourceLocations(newTrainResourceLocations, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_RESOURCE_LOCATIONS__TRAIN_RESOURCE_LOCATIONS, newTrainResourceLocations, newTrainResourceLocations));
	}
	...
	public NotificationChain basicSetStationResourceLocations(StationResourceLocations newStationResourceLocations, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_RESOURCE_LOCATIONS__STATION_RESOURCE_LOCATIONS, oldStationResourceLocations, newStationResourceLocations);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStationResourceLocations(StationResourceLocations newStationResourceLocations) {
		if (newStationResourceLocations != stationResourceLocations) {
			...
			if (stationResourceLocations != null)
				msgs = ((InternalEObject)stationResourceLocations).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_RESOURCE_LOCATIONS__STATION_RESOURCE_LOCATIONS, null, msgs);
			if (newStationResourceLocations != null)
				msgs = ((InternalEObject)newStationResourceLocations).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_RESOURCE_LOCATIONS__STATION_RESOURCE_LOCATIONS, null, msgs);
			msgs = basicSetStationResourceLocations(newStationResourceLocations, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_RESOURCE_LOCATIONS__STATION_RESOURCE_LOCATIONS, newStationResourceLocations, newStationResourceLocations));
	}
	...
	public NotificationChain basicSetCarrierResourceLocations(CarrierResourceLocations newCarrierResourceLocations, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_RESOURCE_LOCATIONS__CARRIER_RESOURCE_LOCATIONS, oldCarrierResourceLocations, newCarrierResourceLocations);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCarrierResourceLocations(CarrierResourceLocations newCarrierResourceLocations) {
		if (newCarrierResourceLocations != carrierResourceLocations) {
			...
			if (carrierResourceLocations != null)
				msgs = ((InternalEObject)carrierResourceLocations).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_RESOURCE_LOCATIONS__CARRIER_RESOURCE_LOCATIONS, null, msgs);
			if (newCarrierResourceLocations != null)
				msgs = ((InternalEObject)newCarrierResourceLocations).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AccountingPackage.FARE_RESOURCE_LOCATIONS__CARRIER_RESOURCE_LOCATIONS, null, msgs);
			msgs = basicSetCarrierResourceLocations(newCarrierResourceLocations, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountingPackage.FARE_RESOURCE_LOCATIONS__CARRIER_RESOURCE_LOCATIONS, newCarrierResourceLocations, newCarrierResourceLocations));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AccountingPackage.FARE_RESOURCE_LOCATIONS__TRAIN_RESOURCE_LOCATIONS:
				return basicSetTrainResourceLocations(null, msgs);
			case AccountingPackage.FARE_RESOURCE_LOCATIONS__STATION_RESOURCE_LOCATIONS:
				return basicSetStationResourceLocations(null, msgs);
			case AccountingPackage.FARE_RESOURCE_LOCATIONS__CARRIER_RESOURCE_LOCATIONS:
