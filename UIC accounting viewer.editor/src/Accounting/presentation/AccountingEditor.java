...
public class AccountingEditor
	 ...
	 * @generated
	 */
	public static final List<String> FILE_EXTENSION_FILTERS = prefixExtensions(AccountingModelWizard.FILE_EXTENSIONS, "*.");
	...
	public class ReverseAdapterFactoryContentProvider extends CustomizedAdapterFactoryContentProvider {
	...
	public void createPagesGen() {
		...
		if (!getEditingDomain().getResourceSet().getResources().isEmpty()) {
			...
			//
			{
				...
				selectionViewer.setContentProvider(new CustomizedAdapterFactoryContentProvider(adapterFactory));
				...
				ViewerPane viewerPane =
					new ViewerPane(getSite().getPage(), AccountingEditor.this) {
						...
						public Viewer createViewer(Composite composite) {
							Tree tree = new Tree(composite, SWT.MULTI);
							TreeViewer newTreeViewer = new TreeViewer(tree);
							newTreeViewer.addFilter(new AccountingViewerFilter());
							return newTreeViewer;
						}
						@Override
						public void requestActivation() {
		...
		if (contentOutlinePage == null) {
			...
			class MyContentOutlinePage extends ContentOutlinePage {
				...
				public void createControl(Composite parent) {
					...
					contentOutlineViewer.setContentProvider(new CustomizedAdapterFactoryContentProvider(adapterFactory));
	...
	public void doSave(IProgressMonitor progressMonitor) {
		...
		AccountingUtils.deleteOrphanedObjects(editingDomain, getModel());
		
		// Save only resources that have actually changed.
		//
		final Map<Object, Object> saveOptions = AccountingResourceUtils.getBinarySaveOptions();
	...
	public void doSaveAs() {
		...
		String[] files = AccountingEditorAdvisor.openFilePathDialog(getSite().getShell(), SWT.SAVE, filters);
		if (files.length > 0) {
	 ...
	 * @generated
	 */
	public EditingDomainActionBarContributor getActionBarContributorGen() {
		return (EditingDomainActionBarContributor)getEditorSite().getActionBarContributor();
	}
	 ...
	 * @generated NOT
	 */
	public AccountingViewerData getModel() {
