...
import Accounting.actions.AccountingValidateAction;
import Accounting.actions.DeleteFolderAction;
import Accounting.actions.ExportJsonAction;
...
public class AccountingActionBarContributor
	...
	public static class NewAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			AccountingModelWizard wizard = new AccountingModelWizard();
	 ...
	 * @generated NOT
	 */
	protected static Collection<BaseSelectionListenerAction> accountingActions;
	 ...
	 * @generated NOT
	 */
	protected IMenuManager accountingMenuManager;
	...
	protected ImportJsonAction importJsonAction = null;	
	protected ExportJsonAction exportJsonAction = null;	
	protected ShowSummaryAction showSummaryAction = null;	
	...
	public AccountingActionBarContributor() {
		...
		validateAction = new AccountingValidateAction();
		controlAction = new ControlAction();
		deleteAction = new DeleteFolderAction();
	...
	public void extendActionBarContributor() {
		...
		if (exportJsonAction == null) {
			exportJsonAction = new ExportJsonAction(this);	
		}
		if (importJsonAction == null) {		
			importJsonAction = new ImportJsonAction(this);
		}

		if (showSummaryAction == null) {
			showSummaryAction = new ShowSummaryAction(this);
		}
		...
		if (accountingActions == null) {
			accountingActions = new ArrayList<BaseSelectionListenerAction>();
		}
	...
	{
	    return new DeleteFolderAction(removeAllReferencesOnDelete());
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		// Prepare for actions.
		accountingMenuManager = new MenuManager(AccountingEditorPlugin.INSTANCE.getString("_UI_ACC_menu_item"));
		submenuManager.insertBefore("additions", accountingMenuManager);
    ...
    */
	...
	protected void addGlobalActions(IMenuManager menuManager) {
		...
		//additional actions
		for (BaseSelectionListenerAction action : accountingActions) {
	...
	public EditingDomain getEditingDomain() {
		return ((AccountingEditor)activeEditor).getEditingDomain();
