...
/**
 * This is the item provider adapter for a {@link Accounting.ReturnValidityConstraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AccountingPackage.Literals.RETURN_VALIDITY_CONSTRAINT__EXCLUDED_WEEKDAYS,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AccountingPackage.Literals.RETURN_VALIDITY_CONSTRAINT__LATEST_RETURN,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AccountingPackage.Literals.RETURN_VALIDITY_CONSTRAINT__EARLIEST_RETURN,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
