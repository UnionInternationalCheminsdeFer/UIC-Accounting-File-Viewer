...
/**
 * This is the item provider adapter for a {@link Accounting.SalesRestriction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SalesRestrictionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_SalesRestriction_salesDates_feature", "_UI_SalesRestriction_type"),
				 AccountingPackage.Literals.SALES_RESTRICTION__SALES_DATES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AccountingPackage.Literals.SALES_RESTRICTION__START_OF_SALE);
			childrenFeatures.add(AccountingPackage.Literals.SALES_RESTRICTION__END_OF_SALE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AccountingPackage.Literals.SALES_RESTRICTION__START_OF_SALE,
				 AccountingFactory.eINSTANCE.createStartOfSale()));

		newChildDescriptors.add
			(createChildParameter
				(AccountingPackage.Literals.SALES_RESTRICTION__END_OF_SALE,
				 AccountingFactory.eINSTANCE.createEndOfSale()));
	}
