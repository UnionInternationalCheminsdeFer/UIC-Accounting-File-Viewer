...
/**
 * This is the item provider adapter for a {@link Accounting.RegionalValidity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RegionalValidityItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AccountingPackage.Literals.REGIONAL_VALIDITY__SEQ_NB,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AccountingPackage.Literals.REGIONAL_VALIDITY__CARRIER_CONSTRAINT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AccountingPackage.Literals.REGIONAL_VALIDITY__SERVICE_CONSTRAINT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AccountingPackage.Literals.REGIONAL_VALIDITY__VIA_STATION);
			childrenFeatures.add(AccountingPackage.Literals.REGIONAL_VALIDITY__ZONE);
			childrenFeatures.add(AccountingPackage.Literals.REGIONAL_VALIDITY__LINE);
			childrenFeatures.add(AccountingPackage.Literals.REGIONAL_VALIDITY__POLYGONE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AccountingPackage.Literals.REGIONAL_VALIDITY__VIA_STATION,
				 AccountingFactory.eINSTANCE.createViaStation()));

		newChildDescriptors.add
			(createChildParameter
				(AccountingPackage.Literals.REGIONAL_VALIDITY__ZONE,
				 AccountingFactory.eINSTANCE.createZone()));

		newChildDescriptors.add
			(createChildParameter
				(AccountingPackage.Literals.REGIONAL_VALIDITY__LINE,
				 AccountingFactory.eINSTANCE.createLine()));

		newChildDescriptors.add
			(createChildParameter
				(AccountingPackage.Literals.REGIONAL_VALIDITY__POLYGONE,
