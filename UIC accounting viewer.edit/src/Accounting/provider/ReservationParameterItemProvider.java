...
/**
 * This is the item provider adapter for a {@link Accounting.ReservationParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReservationParameterItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AccountingPackage.Literals.RESERVATION_PARAMETER__MANDATORY_RESERVATION,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AccountingPackage.Literals.RESERVATION_PARAMETER__ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AccountingPackage.Literals.RESERVATION_PARAMETER__MANDATORY_RESERVATION_FOR_BRANDS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AccountingPackage.Literals.RESERVATION_PARAMETER__MANDATORY_RESERVATIONS_FOR_MODE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AccountingPackage.Literals.RESERVATION_PARAMETER__PARAMS9181);
			childrenFeatures.add(AccountingPackage.Literals.RESERVATION_PARAMETER__OPTIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AccountingPackage.Literals.RESERVATION_PARAMETER__PARAMS9181,
				 AccountingFactory.eINSTANCE.createReservationParams9181()));

		newChildDescriptors.add
			(createChildParameter
				(AccountingPackage.Literals.RESERVATION_PARAMETER__OPTIONS,
				 AccountingFactory.eINSTANCE.createReservationOptions()));
	}
