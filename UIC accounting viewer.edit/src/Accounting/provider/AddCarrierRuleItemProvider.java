...
/**
 * This is the item provider adapter for a {@link Accounting.AddCarrierRule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AddCarrierRuleItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AccountingPackage.Literals.ADD_CARRIER_RULE__CARRIER,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AccountingPackage.Literals.ADD_CARRIER_RULE__SCOPE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AccountingPackage.Literals.ADD_CARRIER_RULE__STATIONS,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		AddCarrierScope labelValue = ((AddCarrierRule)object).getScope();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_AddCarrierRule_type") :
			getString("_UI_AddCarrierRule_type") + " " + label;
	}
