...
/**
 * This is the item provider adapter for a {@link Accounting.CrossBorderCondition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AccountingPackage.Literals.CROSS_BORDER_CONDITION__FROM_COUNTRY,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AccountingPackage.Literals.CROSS_BORDER_CONDITION__TO_COUNTRY,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AccountingPackage.Literals.CROSS_BORDER_CONDITION__AFFECTED_SERVICE_BRANDS,
				 true,
				 false,
				 true,
				 null,
